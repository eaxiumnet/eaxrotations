...
menu.show_dashboard         = core.menu.checkbox(true, "eaxpaladinretribution_show_dashboard")
menu.dashboard_opacity      = core.menu.slider_int(50, 255, 190, "eaxpaladinretribution_dashboard_opacity")
menu.dashboard_scale        = core.menu.slider_float(0.5, 2.0, 1.0, "eaxpaladinretribution_dashboard_scale")
menu.dashboard_x            = core.menu.slider_int(0, 2000, 20, "eaxpaladinretribution_dashboard_x")
menu.dashboard_y            = core.menu.slider_int(0, 2000, 200, "eaxpaladinretribution_dashboard_y")
menu.show_timer_bars = core.menu.checkbox(true, "eaxpaladinretribution_show_timer_bars")
menu.show_action_history = core.menu.checkbox(true, "eaxpaladinretribution_show_action_history")
menu.show_energy_tick = core.menu.checkbox(false, "eaxpaladinretribution_show_energy_tick")
menu.show_combo_points = core.menu.checkbox(false, "eaxpaladinretribution_show_combo_points")
menu.show_threat_bar = core.menu.checkbox(false, "eaxpaladinretribution_show_threat_bar")
menu.enable_smart_collapse = core.menu.checkbox(true, "eaxpaladinretribution_enable_smart_collapse")
