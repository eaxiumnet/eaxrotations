-- class_ui_init.lua  (auto-generated for EAXPaladinRetribution)
...
local function apply()
    ...
    SPEC_ID = identity.SPEC_IDS.PALADIN_RET
    theme.init(
        CLASS_ID,
        SPEC_ID
    )
...
return { apply = apply, display_name = "Paladin Ret", class_id = CLASS_ID, spec_id = SPEC_ID }
