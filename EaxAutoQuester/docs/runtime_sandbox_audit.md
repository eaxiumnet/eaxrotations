...
| `quest_blacklist_sylvanas.lua` (clock, preferred path) | `core.time()` | Documented | `scraped_docs_md/dev/api/core.md:713-736`, `.api/core.lua:229-231` ("seconds since the injection time"). Unchanged — production behaviour is identical. Same call already used at `mount_manager_sylvanas.lua:100`, `progress_tracker_sylvanas.lua:86`, `quest_log_manager_sylvanas.lua:112`. |
