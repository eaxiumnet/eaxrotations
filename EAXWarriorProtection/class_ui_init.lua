-- class_ui_init.lua  (auto-generated for EAXWarriorProtection)
...
local function apply()
    ...
    CLASS_ID = identity.CLASS_IDS.WARRIOR
    SPEC_ID = identity.SPEC_IDS.WARRIOR_PROT
    theme.init(
        CLASS_ID,
        SPEC_ID
    )
...
return { apply = apply, display_name = "Warrior Prot", class_id = CLASS_ID, spec_id = SPEC_ID }
