...
function menu.render()
    ...
    root_tree:render("  Eax's Druid Feral", function()
        ...
        shared_tree:render("  Shared Abilities", function()
            ...
            menu.use_prowl:render("Prowl", "Auto-enter stealth when out of combat in cat form")
            menu.use_pounce:render("Pounce", "Stealth opener — stuns the target")
            menu.use_ravage:render("Ravage", "Stealth opener — high burst damage")
