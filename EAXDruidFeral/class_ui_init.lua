-- class_ui_init.lua  (auto-generated for EAXDruidFeral)
...
local function apply()
    ...
    SPEC_ID = identity.SPEC_IDS.DRUID_FERAL_CAT
    theme.init(
        CLASS_ID,
        SPEC_ID
    )
...
return { apply = apply, display_name = "Druid Feral", class_id = CLASS_ID, spec_id = SPEC_ID }
