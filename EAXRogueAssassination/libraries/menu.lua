...
-- Dashboard
menu.show_dashboard         = core.menu.checkbox(true, "eaxrogueassn_show_dashboard")
menu.dashboard_opacity      = core.menu.slider_int(50, 255, 190, "eaxrogueassn_dashboard_opacity")
menu.dashboard_scale        = core.menu.slider_float(0.5, 2.0, 1.0, "eaxrogueassn_dashboard_scale")
menu.dashboard_x            = core.menu.slider_int(0, 2000, 20, "eaxrogueassn_dashboard_x")
menu.dashboard_y            = core.menu.slider_int(0, 2000, 200, "eaxrogueassn_dashboard_y")
menu.show_timer_bars = core.menu.checkbox(true, "eaxrogueassn_show_timer_bars")
menu.show_action_history = core.menu.checkbox(true, "eaxrogueassn_show_action_history")
menu.show_energy_tick = core.menu.checkbox(true, "eaxrogueassn_show_energy_tick")
menu.show_combo_points = core.menu.checkbox(true, "eaxrogueassn_show_combo_points")
menu.show_threat_bar = core.menu.checkbox(false, "eaxrogueassn_show_threat_bar")
menu.enable_smart_collapse = core.menu.checkbox(true, "eaxrogueassn_enable_smart_collapse")
