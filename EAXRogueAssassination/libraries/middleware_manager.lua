-- EAXRogueAssassination Middleware Manager
-- Integrates libraries/middleware with Assassination Rogue-specific registrations
...
--- Initialize and register all Assassination Rogue-specific middleware
