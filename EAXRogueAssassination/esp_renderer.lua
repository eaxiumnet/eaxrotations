...
--   esp.init("assassination")  -- Call once with unique spec identifier
...
local function draw_hud(menu)
    ...
    elseif spell_id and _icons then
        ...
        if not ok or err == false then
            ...
            if _icons_load_error then
                core.log("[EAX ESP] Icon error: " .. tostring(_icons_load_error))
            end
        end
