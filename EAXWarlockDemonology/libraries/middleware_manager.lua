-- EAXWarlockDemonology Middleware Manager
-- Integrates libraries/middleware with Demonology Warlock-specific registrations
...
-- Spell IDs for TBC Demonology Warlock
...
--- Initialize and register all Demonology Warlock-specific middleware
