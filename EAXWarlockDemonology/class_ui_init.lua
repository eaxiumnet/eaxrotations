-- class_ui_init.lua  (auto-generated for EAXWarlockDemonology)
...
local function apply()
    ...
    SPEC_ID = identity.SPEC_IDS.WARLOCK_DEMONOLOGY
    theme.init(
        CLASS_ID,
        SPEC_ID
    )
...
return { apply = apply, display_name = "Warlock Demonology", class_id = CLASS_ID, spec_id = SPEC_ID }
