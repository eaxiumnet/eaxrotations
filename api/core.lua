...
--- Retrieves the current shapeshift form ID of the local player.
---@return integer The current shapeshift form ID (0 = humanoid, 1 = cat, 2 = bear, etc.).
function core.spell_book.get_shapeshift_form_id()
    return 0
end

--- Casts a shapeshift form by its spell ID.
---@param spell_id integer The ID of the shapeshift form spell to cast.
---@return boolean Whether the cast was successful.
function core.spell_book.cast_shapeshift_form(spell_id)
    return false
end
...
---@class lfg_member_counts
---@field tank integer The number of tanks in the group.
---@field healer integer The number of healers in the group.
---@field dps integer The number of DPS in the group.

--- Returns the member role counts for a specific search result.
---@param index integer The index of the search result.
---@return lfg_member_counts members A table containing tank, healer, and dps counts.
function core.lfg_list.get_search_result_member_counts(index)
