...
---@field __add fun(self: vec3, a: vec3): vec3
---Overloads the subtraction operator for vec3.
---@field __sub fun(self: vec3, a: vec3): vec3
---Overloads the multiplication operator for vec3.
---@field __mul fun(self: vec3, a: vec3 | number): vec3
---Overloads the division operator for vec3.
---@field __div fun(self: vec3, a: vec3 | number): vec3
---Checks equality between two vec3 instances.
---@field __eq fun(self: vec3, a: vec3): boolean
...
---@field length_squared fun(self: vec3): number
---Calculates the dot product between two vec3 instances.
---@field dot fun(self: vec3, v: vec3): number
---Calculates the cross product between two vec3 instances.
---@field cross fun(self: vec3, v: vec3): vec3
---Checks if the vec3 instance is NaN.
---@field is_nan fun(self: vec3): boolean
---Checks if the vec3 instance is zero.
---@field is_zero fun(self: vec3): boolean
---Performs linear interpolation between two vec3 instances.
---@field lerp fun(self: vec3, target: vec3, alpha: number): vec3
---Gets the unit vector of the vec3 instance.
---@field get_unit_vector fun(self: vec3): vec3
...
---@field dist_to fun(self: vec3, other: vec3): number
---Calculates the squared distance to another vec3 instance.
---@field squared_dist_to fun(self: vec3, other: vec3): number
---Calculates the distance to another vec3 instance, ignoring the z-coordinate.
---@field dist_to_ignore_z fun(self: vec3, other: vec3): number
---Calculates the squared distance to another vec3 instance, ignoring the z-coordinate.
---@field squared_dist_to_ignore_z fun(self: vec3, other: vec3): number
---Projects the vec3 instance onto a 2D plane.
---@field project_2d fun(self: vec3): vec3
---Rotates the vec3 instance around a point by a certain number of degrees.
---@field rotate_around fun(self: vec3, origin: vec3, degrees: number): vec3
---Rotates the vec3 instance around the z-axis by a certain number of radians.
---@field rotate_3d_radians fun(self: vec3, angle_radians: number): vec3
---Calculates the dot product between two vec3 instances.
---@field dot_product fun(v1: vec3, v2: vec3): number
---Randomizes the x and y components within a margin.
---@field randomize_xy fun(self: vec3, margin: number): vec3
---Calculates the angle between two vec3 instances with respect to an origin.
---@field get_angle fun(self: vec3, target: vec3, origin: vec3): number
---Checks if a point intersects with a line segment.
---@field intersects fun(self: vec3, segment_end: vec3, point: vec3, margin: number, radius: number, denominator: number): boolean
---Gets the left perpendicular vector of the vec3 instance with respect to an origin.
---@field get_perp_left fun(self: vec3, origin: vec3): vec3
---Gets the left perpendicular vector of the vec3 instance with a factor applied.
---@field get_perp_left_factor fun(self: vec3, origin: vec3, factor: number): vec3
---Gets the right perpendicular vector of the vec3 instance with respect to an origin.
---@field get_perp_right fun(self: vec3, origin: vec3): vec3
---Gets the right perpendicular vector of the vec3 instance with a factor applied.
---@field get_perp_right_factor fun(self: vec3, origin: vec3, factor: number): vec3
---Calculates the distance from the vec3 instance to a line segment.
---@field dist_to_line_segment fun(self: vec3, point_a: vec3, point_b: vec3): number
---Calculates the squared distance from the vec3 instance to a line segment.
---@field squared_dist_to_line_segment fun(self: vec3, point_a: vec3, point_b: vec3): number
---Calculates the squared distance from the vec3 instance to a line segment, ignoring the z-coordinate.
---@field squared_dist_to_ignore_z_line_segment fun(self: vec3, point_a: vec3, point_b: vec3): number
