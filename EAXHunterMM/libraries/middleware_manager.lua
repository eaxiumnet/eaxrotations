-- EAXHunterMM Middleware Manager
-- Integrates libraries/middleware with Marksmanship Hunter-specific registrations
...
-- Spell IDs for TBC Marksmanship Hunter
local HUNTER_SPELLS = {
    -- Racials
...
--- Initialize and register all Marksmanship Hunter-specific middleware
