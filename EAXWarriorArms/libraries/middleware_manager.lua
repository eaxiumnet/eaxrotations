-- EAXWarriorArms Middleware Manager
-- Integrates libraries/middleware with Warrior Arms-specific registrations
...
-- Spell IDs for TBC Warrior Arms
...
--- Initialize and register all Warrior Arms-specific middleware
...
function middleware_manager.initialize(menu)
    ...
    -- Berserking can be used both offensively and defensively
