-- class_ui_init.lua  (auto-generated for EAXWarriorArms)
...
local function apply()
    ...
    SPEC_ID = identity.SPEC_IDS.WARRIOR_ARMS
    theme.init(
        CLASS_ID,
        SPEC_ID
    )
...
return { apply = apply, display_name = "Warrior Arms", class_id = CLASS_ID, spec_id = SPEC_ID }
