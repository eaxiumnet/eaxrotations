-- EAXWarlockAffliction Middleware Manager
-- Integrates libraries/middleware with Affliction Warlock-specific registrations
...
-- Spell IDs for TBC Affliction Warlock
...
--- Initialize and register all Affliction Warlock-specific middleware
