...
menu.life_tap_hp_pct                     = core.menu.slider_int(10, 100, 60, "eaxwarlockaffliction_life_tap_hp_pct")
...
menu.prefer_doom                         = core.menu.checkbox(false, "eaxwarlockaffliction_prefer_doom")
menu.preferred_pet                       = core.menu.combobox(1, "eaxwarlockaffliction_preferred_pet")
menu.min_shards                          = core.menu.slider_int(1, 10, 3, "eaxwarlockaffliction_min_shards")

-- Mana Management (Warlock uses Life Tap + potions/runes)
menu.use_mana_manager = core.menu.checkbox(true, "eaxwarlockaffliction_use_mana_manager")
menu.life_tap_pct = core.menu.slider_int(5, 100, 50, "eaxwarlockaffliction_life_tap_pct")
menu.life_tap_min_hp = core.menu.slider_int(10, 100, 40, "eaxwarlockaffliction_life_tap_min_hp")
menu.mana_potion_pct = core.menu.slider_int(5, 100, 20, "eaxwarlockaffliction_mana_potion_pct")
menu.dark_rune_pct = core.menu.slider_int(5, 100, 15, "eaxwarlockaffliction_dark_rune_pct")

-- Burst & Trinket Automation
menu.auto_burst_enabled = core.menu.checkbox(false, "eaxwarlockaffliction_auto_burst")
menu.burst_on_bloodlust = core.menu.checkbox(true, "eaxwarlockaffliction_burst_bloodlust")
menu.burst_on_pull = core.menu.checkbox(true, "eaxwarlockaffliction_burst_pull")
menu.burst_on_execute = core.menu.checkbox(true, "eaxwarlockaffliction_burst_execute")
menu.burst_in_combat = core.menu.checkbox(false, "eaxwarlockaffliction_burst_always")
menu.cd_min_ttd = core.menu.slider_int(0, 60, 10, "eaxwarlockaffliction_cd_min_ttd")  -- Default 10s for DoTs
menu.trinket1_mode = core.menu.combobox(1, "eaxwarlockaffliction_trinket1_mode")
menu.trinket2_mode = core.menu.combobox(1, "eaxwarlockaffliction_trinket2_mode")
menu.show_dashboard         = core.menu.checkbox(true, "eaxwarlockaffliction_show_dashboard")
menu.dashboard_opacity      = core.menu.slider_int(50, 255, 190, "eaxwarlockaffliction_dashboard_opacity")
menu.dashboard_scale        = core.menu.slider_float(0.5, 2.0, 1.0, "eaxwarlockaffliction_dashboard_scale")
menu.dashboard_x            = core.menu.slider_int(0, 2000, 20, "eaxwarlockaffliction_dashboard_x")
menu.dashboard_y            = core.menu.slider_int(0, 2000, 200, "eaxwarlockaffliction_dashboard_y")
menu.show_timer_bars = core.menu.checkbox(true, "eaxwarlockaffliction_show_timer_bars")
menu.show_action_history = core.menu.checkbox(true, "eaxwarlockaffliction_show_action_history")
menu.show_energy_tick = core.menu.checkbox(false, "eaxwarlockaffliction_show_energy_tick")
menu.show_combo_points = core.menu.checkbox(false, "eaxwarlockaffliction_show_combo_points")
menu.show_threat_bar = core.menu.checkbox(false, "eaxwarlockaffliction_show_threat_bar")
menu.enable_smart_collapse = core.menu.checkbox(true, "eaxwarlockaffliction_enable_smart_collapse")
...
function menu.render()
    ...
    root_tree:render("Eax's Warlock Affliction", function()
        ...
        cd_tree:render("Cooldowns", function()
            ...
            menu.auto_burst_enabled:render("Auto Burst", "Enable burst automation")
            menu.burst_on_bloodlust:render("Burst on Bloodlust", "Trigger on heroism/bloodlust")
            menu.burst_on_pull:render("Burst on Pull", "Trigger at combat start")
            menu.burst_on_execute:render("Burst on Execute", "Trigger in execute phase")
            menu.burst_in_combat:render("Burst Always", "Trigger when available")
            menu.cd_min_ttd:render("Min TTD for CDs", "Don't waste CDs on dying targets")
            menu.trinket1_mode:render("Trinket 1 Mode", "Auto/Combat/Burst")
            menu.trinket2_mode:render("Trinket 2 Mode", "Auto/Combat/Burst")
        ...
        auto_tree:render("Utility", function()
            ...
            menu.use_mana_manager:render("Use Mana Manager", "Life Tap + potions/runes")
            menu.life_tap_pct:render("Life Tap Mana %", "Below this %")
            menu.life_tap_min_hp:render("Life Tap Min HP %", "Don't tap below this %")
            menu.mana_potion_pct:render("Mana Potion %", "Below this %")
            menu.dark_rune_pct:render("Dark Rune %", "Below this %")
