...
ps.col = {
    panel        = c(  9,  7, 18, 252),
    panel_deep   = c(  5,  4, 12, 240),
    border_glow  = c(120,240,120, 220),
    border_dim   = c( 55, 40,110, 160),
    accent       = c(100,220,100, 255),
    accent_mid   = c(100, 85,200, 255),
    text_on      = c(140,255,140, 255),
    text_off     = c( 72, 60,130, 255),
    transparent  = c(  0,   0,   0,   0),
}

local STAR_R, STAR_G, STAR_B = 100, 220, 100
local DUST_R, DUST_G, DUST_B = 90, 40, 200
