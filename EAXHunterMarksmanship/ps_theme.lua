...
ps.col = {
    panel        = c(  7, 14,  8, 252),
    panel_deep   = c(  4,  9,  5, 240),
    border_glow  = c(190,255,140, 220),
    border_dim   = c( 35, 80, 28, 160),
    accent       = c(170,240,120, 255),
    accent_mid   = c( 70,150, 50, 255),
    text_on      = c(210,255,160, 255),
    text_off     = c( 55,100, 40, 255),
    transparent  = c(  0,   0,   0,   0),
}

local STAR_R, STAR_G, STAR_B = 170, 240, 120
local DUST_R, DUST_G, DUST_B = 60, 140, 40
