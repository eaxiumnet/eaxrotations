-- class_ui_init.lua  (auto-generated for EAXHunterMarksmanship)
...
local function apply()
    ...
    SPEC_ID = identity.SPEC_IDS.HUNTER_MM
    theme.init(
        CLASS_ID,
        SPEC_ID
    )
...
return { apply = apply, display_name = "Hunter MM", class_id = CLASS_ID, spec_id = SPEC_ID }
