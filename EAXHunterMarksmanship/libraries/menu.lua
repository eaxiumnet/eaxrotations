...
menu.use_scare_beast = core.menu.checkbox(false, "eaxhuntermm_use_scare_beast")
menu.use_flare       = core.menu.checkbox(false, "eaxhuntermm_use_flare")
menu.auto_stealth_flare = core.menu.checkbox(true, "eaxhuntermm_auto_stealth_flare")
menu.stealth_warning    = core.menu.checkbox(true, "eaxhuntermm_stealth_warning")
    menu.stealth_scan_radius = core.menu.slider_float(10.0, 60.0, 20.0, "eaxhuntermm_stealth_scan_radius")
    menu.stealth_prediction_s = core.menu.slider_float(0.00, 0.75, 0.20, "eaxhuntermm_stealth_prediction_s")
    menu.stealth_overlay_enabled = core.menu.checkbox(true, "eaxhuntermm_stealth_overlay_enabled")
    menu.stealth_overlay_direction = core.menu.checkbox(true, "eaxhuntermm_stealth_overlay_direction")
menu.sync_pet_autocast = core.menu.checkbox(true, "eaxhuntermm_sync_pet_autocast")
menu.disable_growl_in_group = core.menu.checkbox(true, "eaxhuntermm_disable_growl_in_group")
