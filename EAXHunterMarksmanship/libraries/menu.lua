...
menu.use_bestial_wrath  = core.menu.checkbox(true, "eaxhuntermm_use_bestial_wrath")
menu.use_intimidation   = core.menu.checkbox(true, "eaxhuntermm_use_intimidation")
...
local spec_name = "Hunter Marksmanship"
