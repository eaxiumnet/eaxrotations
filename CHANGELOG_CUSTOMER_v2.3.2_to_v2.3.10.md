...
## Versions 2.3.2 through 2.3.10

---

## v2.3.10 — Hunter Rotation Load Fix (Latest)

### Bug Fixes
- **Hunter (all specs — Beast Mastery, Marksmanship, Survival)**: Fixed a critical issue where the Hunter rotation would fail to load entirely, showing an error about a missing module. This prevented the rotation from running at all for Hunter characters.
  - The root cause was missing logic for automatically switching between Aspect of the Hawk (damage) and Aspect of the Viper (mana regen) in the shared aspect manager.
  - Added the missing Hawk/Viper switching strategies so the rotation loads and runs correctly.

### What to Expect
- Hunters: Your rotation now loads and executes normally.
- Aspect of the Viper still switches in automatically when your mana drops low in combat.
- Aspect of the Hawk switches back automatically once your mana recovers.
- Both respect your "Auto Aspect" setting if you have it disabled.
...
| What | v2.3.2 | v2.3.3 | v2.3.4 | v2.3.5 | v2.3.6 | v2.3.7 | v2.3.8 | v2.3.9 | v2.3.10 |
|------|--------|--------|--------|--------|--------|--------|--------|--------|---------|
