...
NS.CC_DEBUFFS = NS.CC_DEBUFFS or {
    ...
    5782, 6213, 6215, 5484, 17928, 8122, 30615, 22884, 33111, 39415, 39427, 46561, -- Fear / Howl / Psychic Scream / Bellowing Roar (expanded from WoWHead dungeon/raid guides: Skyriss, TK, SWP Sunblade Dusk Priest etc.)
    ...
    for i = 1, count do
        ...
        if NS.unit_alive(u) and (NS.same_unit(u, me) or safe(is_friend_with, u, me)) and distance(u, me) <= 40 then
            ...
            if NS.debuff_up then
                for _, fid in ipairs({5782,6215,5484,8122,33111,30615,22884,33676,33684,19134,36922,39415,39427,46561}) do
