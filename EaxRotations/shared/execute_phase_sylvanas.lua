...
-- ============================================================================
-- Readability notes:
--   What: pure execute-phase and low-health target gates.
--   When: classes need to decide if an execute-style ability is allowed.
--   Why: shared thresholds avoid each spec inventing its own low-health logic.
--   Safety: nil and non-number health values are normalized before comparison.
