...
M.CHANNEL_SPELLS = {
    ...
    DrainSoul = {
        ids = {27217, 11698, 11697, 11696, 11695, 11689, 11675, 8289, 8288, 1120},
        base_duration = 15.0,
        tick_interval = 3.0,
        ticks = 5,
        clip_tick = nil,
    ...
    -- Mage
    ArcaneMissiles = {
        ids = {25345, 10274, 10273, 8418, 8417, 8416, 8415, 8414, 8413, 8412, 5149, 5148, 5147, 5146, 5145, 5144, 5143},
        base_duration = 5.0,
        tick_interval = 1.0,
        ticks = 5,
        clip_tick = nil,
    ...
    Blizzard = {
        ids = {27085, 10193, 10192, 10191, 10190, 10189, 10188, 10187, 10186, 10185, 8427, 6141, 10},
        base_duration = 8.0,
        tick_interval = 1.0,
        ticks = 8,
        clip_tick = nil,
