...
-- ============================================================================
-- Readability notes:
--   What: converts SimulationCraft Action Priority List (APL) syntax into
--         EaxRotations strategy tables (name, matches, execute).
--   When: importing theorycrafted rotations from WoWSims / SimC / Raidbots.
--   Why: eliminates hand-translation errors and keeps Eax rotations synced
--         with community sim profiles.
--   Safety: pure Lua, zero game API dependencies, fully unit-testable.
--         Generated strategies reference NS / SPELLS / state at runtime.
--
-- Usage:
