...
-- WHAT:  Validates that the 10 retribution_wotlk strategies are compiled correctly by the DSL
...
assert_true(#ret.strategies == 10, "retribution_wotlk should have 10 strategies")
