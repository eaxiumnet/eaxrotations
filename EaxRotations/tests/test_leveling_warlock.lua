-- test_leveling_warlock.lua -- Warlock leveling rotation tests.
-- WHAT:  Warlock leveling rotation tests
...
do
    ...
    local target_dependent = {4, 6, 7, 9, 11, 12, 13, 14, 15, 16, 17, 18}
...
do
    test("summon_pet_spell_nil: summon chain handles nil SPELLS entries", function()
        ...
        local saved_guard = NS.WarlockSpells.SummonFelguard
        local saved_hunter = NS.WarlockSpells.SummonFelhunter
        NS.WarlockSpells.SummonFelguard = nil
        NS.WarlockSpells.SummonFelhunter = { 19647 }
        ...
        NS.WarlockSpells.SummonFelguard = saved_guard
        NS.WarlockSpells.SummonFelhunter = saved_hunter
    end)
end
-- Summary
-- ============================================================================
