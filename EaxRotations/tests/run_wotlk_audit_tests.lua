...
local WOTLK_REFERENCE_ALIASES = {
    ...
    [43038] = { kind = "VALID_BRIDGE_GAP", family = "Ice Barrier", source = "wowhead WotLK Classic spell=43038/ice-barrier - Rank 7 (2860 absorb); absent from the local WotLK bridge" },
}
