...
local WOTLK_REFERENCE_ALIASES = {
    ...
    [48127] = { kind = "VALID_RANK_ALIAS", family = "Mind Blast", source = "ui/shadow_priest/apls/default.apl.json" },
    [48156] = { kind = "VALID_RANK_ALIAS", family = "Mind Flay", source = "ui/shadow_priest/apls/default.apl.json" },
    ...
    -- 48927 was pinned here as "Holy Shield 3.3.5 max rank" but wowhead WotLK
    -- 404s it and the wowsims pal_prot APL casts 48952 — the pin was false
    -- (2026-09-12). Moved to WOTLK_REJECTED_IDS; 48952 is the real max rank.
    ...
    -- 2026-09-11 disc guide-pass pin: Inner Focus 14751 is a single-rank
    -- talent (Wowhead WotLK Classic spell=14751/inner-focus; no rank
    -- increases; bridge omits it).
    [14751] = { kind = "VALID_RANK_ALIAS", family = "Inner Focus", source = "wowhead WotLK Classic spell=14751/inner-focus (single-rank talent, 100% mana discount + 25% crit on next spell)" },
    ...
    -- 2026-09-10 bear/fire guide-pass pins (each Wowhead wotlk verified):
    [6795] = { kind = "VALID_RANK_ALIAS", family = "Growl", source = "wowhead.com/wotlk/spell=6795 - single-rank taunt, 8s CD" },
    [5209] = { kind = "VALID_RANK_ALIAS", family = "Challenging Roar", source = "wowhead.com/wotlk/spell=5209 - 10yd AoE taunt 6s, 10-min CD" },
    [5229] = { kind = "VALID_RANK_ALIAS", family = "Enrage", source = "wowhead.com/wotlk/spell=5229 - instant 20+10 rage, 1-min CD" },
    [42949] = { kind = "VALID_RANK_ALIAS", family = "Dragon's Breath", source = "wowhead.com/wotlk/spell=42949 - Rank 5 instant cone, 20s CD (TBC ladder tops at 33043/R4)" },
    -- 2026-09-11 rogue/warlock thin guide-pass pins (each Wowhead wotlk verified):
    [14177] = { kind = "VALID_RANK_ALIAS", family = "Cold Blood", source = "wowhead.com/wotlk/spell=14177 - single-rank talent, next crit spell" },
    [48676] = { kind = "VALID_RANK_ALIAS", family = "Garrote", source = "wowhead.com/wotlk/spell=48676 - Rank 9 stealth opener, 3s silence" },
    [47865] = { kind = "VALID_RANK_ALIAS", family = "Curse of the Elements", source = "wowhead.com/wotlk/spell=47865 - Rank 4 amp; the APL fixture 47867 is not the live WotLK max rank" },
    [47827] = { kind = "VALID_RANK_ALIAS", family = "Shadowburn", source = "wowhead.com/wotlk/spell=47827 - Rank 3 execute finisher, shard generation" },
    [47823] = { kind = "VALID_RANK_ALIAS", family = "Hellfire", source = "wowhead.com/wotlk/spell=47823 - Rank 9 channeled AoE" },
    [46968] = { kind = "VALID_RANK_ALIAS", family = "Shockwave", source = "wowhead.com/wotlk/spell=46968 - prot talent, 20s CD cone stun" },
    [48817] = { kind = "VALID_RANK_ALIAS", family = "Holy Wrath", source = "wowhead.com/wotlk/spell=48817 - 30s CD, 10yd stun/damage (the WotLK max rank)" },
    -- 2026-09-13 spell-id sweep: 37897 was pinned as "Holy Wrath r4" but
    -- wowhead.com/wotlk/spell=37897 is Parachute, and 31898 as "Holy Wrath r5"
    -- but it is Judgement of Blood. Both were removed from the paladin ladders;
    -- the era-shared real ranks below replace them.
    [27139] = { kind = "VALID_RANK_ALIAS", family = "Holy Wrath", source = "wowhead TBC spell=27139 - Holy Wrath rank (69), era-shared with WotLK" },
    [10318] = { kind = "VALID_RANK_ALIAS", family = "Holy Wrath", source = "wowhead TBC spell=10318 - Holy Wrath rank (60), era-shared with WotLK" },
    [2812]  = { kind = "VALID_RANK_ALIAS", family = "Holy Wrath", source = "wowhead TBC spell=2812 - Holy Wrath rank 1 (50), era-shared with WotLK" },
    ...
    -- 2026-09-13 spell-id sweep: 2944 is Devouring Plague, not Shadow Word:
    -- Death. The wrong-family tail was removed from the ShadowWordDeath ladder;
    -- this pin now documents the id's legitimate DEVOURING_PLAGUE_DEBUFF use.
    [2944] = { kind = "VALID_RANK_ALIAS", family = "Devouring Plague", source = "wowhead.com/wotlk/spell=2944 - Devouring Plague (bridge-known); listed because DEVOURING_PLAGUE_DEBUFF legitimately carries it" },
    ...
    [1719] = { kind = "VALID_SHARED_ID", family = "Recklessness", source = "wowhead WotLK Classic spell=1719/recklessness - Berserker-stance 5-min burst CD (+100% crit on the next 3 specials); era-shared with TBC, so the classifier TBC_ID_IN_WOTLK path needs this alias" },
    [1122] = { kind = "VALID_SHARED_ID", family = "Summon Infernal", source = "wowhead WotLK Classic spell=1122/summon-infernal - 10-min guardian burst CD; era-shared with TBC (the affliction fixture casts it)" },
    [17941] = { kind = "VALID_SHARED_ID", family = "Shadow Trance", source = "wowhead WotLK Classic spell=17941/shadow-trance - the Nightfall proc buff (10s, next Shadow Bolt instant); era-shared with TBC" },
    -- 2026-09-13 any-slot sweep: the warlock leveling Create Soulstone ladder
    -- carried 20770 (Resurrection) plus two "Use Soulstone" ids. The real ranks
    -- are era-shared with TBC, and the local WotLK bridge stops at 27238 r70 /
    -- 47884 r76, so the classifier read the lower ranks as TBC-only. All three
    ...
    -- wowsims pal_prot fixture).
    [59172] = { kind = "VALID_BRIDGE_GAP", family = "Chaos Bolt", source = "wowhead WotLK Classic spell=59172/chaos-bolt - level-80 max rank (2.5s cast / 12s CD); the file shipped the level-60 rank 1 (50796) as the ladder head, so a level-80 warlock cast rank 1" },
    [47440] = { kind = "VALID_BRIDGE_GAP", family = "Commanding Shout", source = "wowhead WotLK Classic spell=47440/commanding-shout - level-80 max rank (2-min raid health buff, 10 rage); the wowsims war_prot APL keeps it refreshed but the bridge omits it" },
    [48952] = { kind = "VALID_BRIDGE_GAP", family = "Holy Shield", source = "wowhead WotLK Classic spell=48952/holy-shield - the real 3.3.5 max rank (8 charges / 10s / 8s CD) and the id the wowsims pal_prot APL casts; replaces the disproven 48927" },
    [51886] = { kind = "VALID_BRIDGE_GAP", family = "Cleanse Spirit", source = "wowhead WotLK Classic spell=51886/cleanse-spirit - WotLK dispel (1 poison / 1 disease / 1 curse, instant, 40y); absent from the local WotLK bridge" },
    [498] = { kind = "VALID_BRIDGE_GAP", family = "Divine Protection", source = "wowhead WotLK Classic spell=498/divine-protection - single rank (-50% damage taken 12s, 3-min CD); absent from the local WotLK bridge" },
    [51730] = { kind = "VALID_BRIDGE_GAP", family = "Earthliving Weapon", source = "wowhead WotLK Classic spell=51730/earthliving-weapon - the 30-min resto self imbue (6% mana); absent from the local WotLK bridge" },
}
...
local WOTLK_REJECTED_IDS = {
    ...
    [48927] = true, -- wowhead WotLK Classic 404s 48927: NOT Holy Shield (false pin removed 2026-09-12; 48952 is the real max rank)
}
...
local function run_self_tests()
    ...
    -- +3 spell-id sweep any-slot pass 2026-09-13: 20752 / 20755 / 20756 (Create Soulstone
    -- Lesser / plain / Greater) are era-shared with TBC but absent from the local WotLK
    -- bridge; they replace the wrong-spell ids 20770 (Resurrection) and 20759 / 20758
    -- (Use Soulstone) in the warlock leveling ladder. Prior pin was 257.
    expect(map_count(WOTLK_REFERENCE_ALIASES), 260, "pinned allowlist size") -- +1 spell-id sweep 2026-09-13: the three disproven Holy Wrath pins 37897/31898 were replaced by the real era-shared ranks 27139/10318/2812 (net +1); 2944 was relabelled Devouring Plague -- prior: +6 thin-spec guide-pass pins 2026-09-12 (47867 Curse of Doom, 50589 Immolation Aura, 57755 Heroic Throw = VALID_BRIDGE_GAP; 1719 Recklessness, 1122 Summon Infernal, 17941 Shadow Trance = VALID_SHARED_ID) -- +3 school-lockout wave 2026-09-11 (33831 Force of Nature shared id, 43039/43038 Ice Barrier bridge-gap ranks 8/7) -- +1 disc guide-pass pin 2026-09-11 (14751 Inner Focus single-rank talent; 25437/34433/48073 reused from prior pins) -- +4 bear/fire guide-pass pins 2026-09-10 (6795 Growl, 5209 Challenging Roar, 5229 Enrage, 42949 Dragon's Breath R5) -- +1 holy upkeep pin 2026-09-10 (48073 Divine Spirit WotLK max; 48168 Inner Fire already in the era reference map) -- +6 DPS thin-spec close-out pins 2026-09-10 (48660 Hemorrhage, 48467 Hurricane, 71165/47246/47245 Molten Core, 63165 Decimation) -- +2 healer close-out pins 2026-09-10 (64901 Divine Hymn, 64904 Hymn of Hope) -- +2 spell-coverage sweep pins 2026-09-10 (49802 Maim, 42945 Blast Wave) -- +5 thin-spec guide-pass pins 2026-09-12 (59172 Chaos Bolt r4, 47440 Commanding Shout, 48952 Holy Shield max, 51886 Cleanse Spirit, 51730 Earthliving Weapon; minus the disproven 48927 Holy Shield alias) -- +6 rogue/warlock thin guide-pass pins 2026-09-11 (14177 Cold Blood, 48676 Garrote r9, 51723 Fan of Knives, 47865 Curse of Elements r4, 47827 Shadowburn r3, 47823 Hellfire r9) -- prior: +13 DPS/tank guide-pass pins 2026-09-09 (61336/22812/46968/48817/37897/31898/53023/49821/48158/48157/32379/2944/13750) -- prior: +14 holy priest guide-gap pins 2026-09-09 (25437/19243/19242/19241/19240/19238/19236/13908/48087/48086/28275/27871/27870/7001) -- prior: +10 WotLK healer wave pins 2026-09-09 (17116/48477/26994/20484/48447/20216/20166/33206/10060/16188) -- prior: +4 warrior W3.3 pins (57823/46916/70847/12975) +6 priest CoH TBC-era ranks (34861/34862/34863/34864/34865/34866) 2026-08-13
