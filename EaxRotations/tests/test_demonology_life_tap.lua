-- test_demonology_life_tap.lua -- Demonology Life Tap tests.
-- WHAT:  Demonology Life Tap anti-spam and threshold tests.
-- WHEN:  During rotation test suite execution.
-- WHY:   Protects against Life Tap double-casting in demonology spec.
...
local st = { mana_pct = 20, hp_pct = 80, life_tap_ready = true }
...
print("PASS test_demonology_life_tap")
