...
return {
    ...
    },
    {
        spec = "druid/resto",
        missing_in = "wotlk",
        names = { "AbolishPoison", "Bash", "BearFormFocusedByMelee", "CatFormRepositionFallback", "ClearcastRegrowth", "CycloneEnemyHealer", "DownrankHealingTouch", "EntanglingRootsMelee", "FSRPause", "FeralCharge", "FriendlyTarget", "HealingTouchMaxEmergency", "Healthstone", "InnervateHealer", "InnervateSelf", "LeaveTreeForDirectHeal", "LifebloomLetBloom", "ManaPotionFloor", "MovingLifebloom", "MovingRejuvenation", "NaturesGraspMelee", "PreemptiveRegrowth", "PriorityRejuvenation", "RaidLifebloomCoverage", "RebirthBattleRez", "RegrowthSpotHeal", "RemoveCurse", "SecondRaidLifebloomCoverage", "SoloInsectSwarm", "SoloMoonfire", "SoloWrath", "SwiftmendEmergency", "TankLifebloomStack", "TranquilityEmergency", "TravelFormReposition", "TreeOfLifeMaintain" },
