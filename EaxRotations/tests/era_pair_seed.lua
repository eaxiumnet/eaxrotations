...
return {
    ...
    },
    {
        spec = "druid/balance",
        missing_in = "vanilla",
        names = { "Bash", "FeralCharge", "ForceOfNature", "Healthstone", "InnervateHealer", "InsectSwarmSpread", "ManaGem", "MoonfireSpread", "MoonkinForm", "MovingMoonfire", "PvP_Cyclone", "Starfall" },
