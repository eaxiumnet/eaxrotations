...
assert_true(strategy_names["WarStomp"], "WarStomp should be present - feature: AoE stun on 4+ melee enemies")
assert_true(strategy_names["MarkOfTheWild"], "MarkOfTheWild should be present - feature: party/raid buff")

print("PASS test_balance_war_stomp (gap audit: " .. #strategies .. " strategies present, 2 gaps closed)")
