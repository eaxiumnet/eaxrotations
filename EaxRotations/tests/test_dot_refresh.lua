-- test_dot_refresh.lua — Verify DoT refresh windows and clipping logic for DoT-based specs.
-- WHAT:  Verify DoT refresh windows and clipping logic for DoT-based specs.
