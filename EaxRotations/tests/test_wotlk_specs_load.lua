-- test_wotlk_specs_load.lua — WotLK spec load verification.
-- WHAT:  Loads every new WotLK spec with a mocked NS and verifies it returns a table with strategies and build_state.
-- WHEN:  During WotLK test suite execution.
-- WHY:   Regression guard for the WotLK spec rollout.
...
local specs = {
    { file = "EaxRotations/classes/hunter/beast_mastery_wotlk.lua", name = "beast_mastery" },
    { file = "EaxRotations/classes/hunter/marksmanship_wotlk.lua", name = "marksmanship" },
    { file = "EaxRotations/classes/hunter/survival_wotlk.lua", name = "survival" },
    { file = "EaxRotations/classes/rogue/assassination_wotlk.lua", name = "assassination" },
    { file = "EaxRotations/classes/rogue/combat_wotlk.lua", name = "combat" },
    { file = "EaxRotations/classes/rogue/subtlety_wotlk.lua", name = "subtlety" },
    { file = "EaxRotations/classes/warlock/affliction_wotlk.lua", name = "affliction" },
    { file = "EaxRotations/classes/warlock/demonology_wotlk.lua", name = "demonology" },
    { file = "EaxRotations/classes/warlock/destruction_wotlk.lua", name = "destruction" },
    { file = "EaxRotations/classes/priest/discipline_wotlk.lua", name = "discipline" },
    { file = "EaxRotations/classes/priest/holy_wotlk.lua", name = "holy" },
    { file = "EaxRotations/classes/priest/shadow_wotlk.lua", name = "shadow" },
    { file = "EaxRotations/classes/shaman/elemental_wotlk.lua", name = "elemental" },
    { file = "EaxRotations/classes/shaman/enhancement_wotlk.lua", name = "enhancement" },
    { file = "EaxRotations/classes/shaman/restoration_wotlk.lua", name = "restoration" },
    { file = "EaxRotations/classes/druid/balance_wotlk.lua", name = "balance" },
    { file = "EaxRotations/classes/druid/cat_wotlk.lua", name = "cat" },
    { file = "EaxRotations/classes/druid/bear_wotlk.lua", name = "bear" },
    { file = "EaxRotations/classes/druid/resto_wotlk.lua", name = "resto" },
    { file = "EaxRotations/classes/mage/fire_wotlk.lua", name = "fire" },
    { file = "EaxRotations/classes/mage/frost_wotlk.lua", name = "frost" },
    { file = "EaxRotations/classes/paladin/holy_wotlk.lua", name = "holy" },
    { file = "EaxRotations/classes/paladin/protection_wotlk.lua", name = "protection" },
    { file = "EaxRotations/classes/warrior/fury_wotlk.lua", name = "fury" },
    { file = "EaxRotations/classes/warrior/protection_wotlk.lua", name = "protection" },
}
...
for i = 1, #specs do
    ...
    local ok, err = pcall(function()
        ...
        local mod = dofile(spec.file)
        assert_true(type(mod) == "table", spec.file .. " should return a table")
        assert_true(type(mod.strategies) == "table", spec.file .. " should expose strategies")
        assert_true(type(mod.build_state) == "function", spec.file .. " should expose build_state")
        assert_true(registered[spec.name] ~= nil, spec.file .. " should register under '" .. spec.name .. "'")
        ...
        for _, s in ipairs(mod.strategies) do
            ...
            assert_true(m == true or m == false, spec.file .. " strategy " .. s.name .. " matches should return boolean")
        end
    end)
    if ok then
        passed = passed + 1
    else
        failures[#failures + 1] = spec.file .. ": " .. tostring(err)
    end
end

print("Tests: " .. passed .. "/" .. #specs .. " passed")
if #failures > 0 then
    print("FAILURES:")
