...
-- proven-otherwise). The fallback set: druid caster, warrior kebab.
-- (shaman restoration joined the delta set 2026-09-18: the Riptide
-- capstone loop + Water Shield rework; paladin protection joined
-- 2026-09-18: the Seal of Fury tank seal + Judgement taunt pair — the
-- first prot taunt; paladin retribution joined 2026-09-18: the Holy
-- Strike weave.)
local SPECS = {
    ["druid/balance"] = true,
    ["druid/bear"] = true,
