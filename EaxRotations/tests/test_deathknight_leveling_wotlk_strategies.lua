...
-- MindFreeze must HOLD when the target's cast is about to land (the interrupt
...
-- ============================================================================
assert_lane("MindFreeze fires with 1.0s left on the enemy cast", "MindFreeze",
    function() casting = true; cast_remaining = 1.0; cast_lead = nil end, true)
assert_lane("MindFreeze holds when only 0.05s of the cast remains", "MindFreeze",
    function() casting = true; cast_remaining = 0.05; cast_lead = nil end, false)
assert_lane("MindFreeze holds ON the 0.30s lead floor", "MindFreeze",
    function() casting = true; cast_remaining = 0.30; cast_lead = nil end, false)
assert_lane("MindFreeze fires above the 0.30s lead floor", "MindFreeze",
    function() casting = true; cast_remaining = 0.31; cast_lead = nil end, true)
assert_lane("MindFreeze honours a raised interrupt_lead_sec setting", "MindFreeze",
