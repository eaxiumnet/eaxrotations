...
-- Change: Test Classic expansion routing in class loader
-- =========================================================================
local __eax_file = "tests/test_classic_warrior_spec.lua"
local __eax_version = "1.1.1"
local __eax_modified = "2026-05-28"
local __eax_change = "Test expansion-aware class loading"
