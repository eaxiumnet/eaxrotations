...
-- WHAT:  Validates that the 9 holy_wotlk strategies are compiled correctly by
...
-- Priority order test
-- ============================================================================
-- Healer wave (2026-09-09): mana-game band (SoW upkeep, judge-on-CD,
...
-- BeaconOfLight (5): matches when beacon_up falsy
