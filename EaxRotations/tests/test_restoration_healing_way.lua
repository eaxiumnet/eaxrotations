...
-- =========================================================================
local __eax_file = "tests/test_restoration_healing_way.lua"
...
-- Feature audit for restoration_sylvanas: Healing Way stacking + missing FrostByte features.
...
-- ============================================================================	-- Present features (verify core abilities exist - using actual spec strategy names)
	...
	assert_true(strategy_names["NaturesSwiftness"], "NaturesSwiftness should be present")		-- Present FrostByte features (now implemented)
		assert_true(strategy_names["HealingWay"], "HealingWay should be present - FrostByte feature: healing throughput buff tracking")
		assert_true(strategy_names["ChainHeal"], "ChainHeal should be present - FrostByte feature: Chain Heal smart targeting")
	
	print("PASS test_restoration_healing_way (gap audit: " .. count .. " strategies present, 2 FrostByte gaps closed)")
