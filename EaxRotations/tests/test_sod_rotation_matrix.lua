...
local roles = {
    ...
    { class = "mage", key = "sod_mage_dps", path = "classes/mage/dps_mage_sod",
        order = { "Evocation", "FrozenOrb", "LivingBomb", "BalefireBolt", "SpellfrostBolt", "FrostfireBolt", "IcyVeins", "Frostbolt" },
    ...
    { class = "paladin", key = "sod_paladin_protection", path = "classes/paladin/protection_sod",
        order = { "SealMartyr", "LayOnHands", "DivineProtection", "HolyShield", "Judgement", "AvengersShield", "HammerOfTheRighteous", "Exorcism", "ShieldOfRighteousness" },
    ...
    { class = "paladin", key = "sod_paladin_retribution", path = "classes/paladin/retribution_sod",
        order = { "LayOnHands", "DivineShield", "SealMartyr", "AvengingWrath", "Judgement", "DivineStorm", "Exorcism", "CrusaderStrike", "HammerOfWrath", "Consecration" },
    ...
    { class = "rogue", key = "sod_rogue_combat", path = "classes/rogue/combat_sod",
        order = { "BladeFlurry", "AdrenalineRush", "FanOfKnives", "CrimsonTempest", "SliceAndDice", "Envenom", "PoisonedKnife", "Mutilate", "SaberSlash" },
    ...
    { class = "shaman", key = "sod_shaman_elemental", path = "classes/shaman/elemental_sod",
        order = { "ShamanisticRage", "FeralSpirit", "FlameShock", "ChainLightning", "LavaBurst", "EarthShockMoving", "FireNova", "LightningBolt" },
        context = { mana_pct = 50 } },
    ...
    { class = "shaman", key = "sod_shaman_restoration", path = "classes/shaman/restoration_sod",
        order = { "NaturesSwiftness", "NaturesSwiftnessHealingWave", "ShamanisticRage", "WaterShield", "ManaTideTotem", "EarthShield", "Riptide", "HealingRain", "ChainHeal", "LesserHealingWave", "HealingWave", "HealingStreamTotem" },
