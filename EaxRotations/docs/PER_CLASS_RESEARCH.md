...
| **Behavioral battery** | `EaxRotations/tests/` (569 suites) | 2,633 decision rules across 132 specs prove every rule *fires* in some state; never-triage gates strict across all 4 eras (scorecard: tbc 11 · wotlk 0 · vanilla 9 · sod 0). |
