...
Total: 469 rotation suites + 33 leveling suites registered (466/466 rotation passing at runtime; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator).
