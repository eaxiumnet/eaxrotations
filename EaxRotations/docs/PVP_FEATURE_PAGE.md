...
Total: 596 rotation suites + 39 leveling suites registered (596/596 rotation passing at runtime — incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator).
---
