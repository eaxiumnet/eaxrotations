...
Total: 470 rotation suites + 33 leveling suites registered (467/467 rotation passing at runtime; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator).
