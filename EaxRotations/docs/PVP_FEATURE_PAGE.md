...
Total: 597 rotation suites + 43 leveling suites registered (597/597 rotation passing at runtime — incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator).
---
