...
Total: 565 rotation suites + 39 leveling suites registered (565/565 rotation passing at runtime — incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator).
---
...
EaxRotations v2.26.1 — CC-BY-4.0 License — Built for TBC Classic Anniversary
