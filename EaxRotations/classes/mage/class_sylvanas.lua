...
local SPELLS = {
    ...
    Fireball = NS.spell_action({
        ...
        levels = {70, 66, 60, 60, 54, 48, 42, 36, 30, 24, 18, 12, 6, 1},
        cast_time = 3.0,
        cooldown = 0,
        power_cost = 0,
        power_type = "mana",
    ...
    Frostbolt = NS.spell_action({
        name = "Frostbolt",
        ids = {38697, 27072, 25304, 10181, 10180, 10179, 8408, 8407, 8406, 7322, 837, 205, 116},
        levels = {70, 69, 60, 56, 50, 44, 38, 32, 26, 20, 14, 8, 4},
        cast_time = 3.0,
        cooldown = 0,
        power_cost = 0,
        power_type = "mana",
