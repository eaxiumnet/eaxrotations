...
local ACTION = {
    ...
    Fireball       = define("Fireball",       {38692, 27070, 25306, 10151, 10150, 10149, 10148, 8402, 8401, 8400, 3140, 145, 143, 133}, "Fireball"),
    FrostNova      = define("FrostNova",      {27088, 10230, 6131, 865, 122}, "FrostNova"),
    Frostbolt      = define("Frostbolt",      {38697, 27072, 25304, 10181, 10180, 10179, 8408, 8407, 8406, 7322, 837, 205, 116}, "Frostbolt"),
