...
local strategies = {
    ...
    { name = "UnavailableClassicHunterInterrupt", matches = function() return false end, execute = function(context) return NS.try_cast(SPELLS.UnavailableClassicHunterInterrupt, context.target, "[MARKSMANSHIP] Silencing Shot", { expected_cooldown = 20 }) end },
