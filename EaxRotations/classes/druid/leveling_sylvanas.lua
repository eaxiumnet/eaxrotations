...
-- =========================================================================
local __eax_file = "classes/druid/leveling_sylvanas.lua"
...
-- ============================================================================
-- What: Druid leveling rotation for solo questing (Feral priority + Caster fallback)
-- When: Evaluated on leveling/solo context by shared leveling dispatcher
-- Why: Feral (Bear survival, Cat DPS) is the recommended leveling spec per TBC guides;
--       caster form serves as fallback for low levels (<20) or mana-heavy situations
-- Safety: Context guard and spell checks are nil-safe; pcall-guarded API calls;
--         form-shifting auto-cancels previous form (TBC native); conservative defaults
-- ============================================================================
