        ...
        sections = {
            ...
            },
            {
                ...
                settings = {
                    ...
                    { key = "auto_taunt", type = "checkbox", label = "Auto Taunt (Growl)", default = true, tooltip = "Automatically use Growl to taunt targets off allies. Disable to save taunt for manual use." },
            ...
            },
            {
                ...
                settings = {
                    ...
                    { key = "cat_auto_prowl", type = "checkbox", label = "Auto Prowl OOC", default = true, tooltip = "Automatically enter Prowl (stealth) out of combat when approaching an enemy." },
            ...
            },
            {
                ...
                settings = {
                    ...
                    { key = "resto_rejuv_hp_tank", type = "slider", label = "Rejuvenation HP% (Tank)", min = 0, max = 100, default = 92, tooltip = "Cast Rejuvenation on tanks at or below this HP%." },
                    { key = "resto_rejuv_hp_raid", type = "slider", label = "Rejuvenation HP% (Raid)", min = 0, max = 100, default = 88, tooltip = "Cast Rejuvenation on raid/party members at or below this HP%." },
                    ...
                    { key = "druid_resto_group_aware_utility", type = "checkbox", label = "Group-Aware Restoration Utility", default = true, tooltip = "Require group/raid context for Rebirth battle rez and group dispels. Disable to block these group-only utilities." },
                },
            },
            {
