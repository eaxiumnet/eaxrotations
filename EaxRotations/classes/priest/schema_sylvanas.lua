        ...
        sections = {
            ...
            },
            {
                ...
                settings = {
                    ...
                    { key = "priest_auto_fade", type = "checkbox", label = "Auto Fade (Threat)", default = true, tooltip = "Cast Fade in combat when threat exceeds the threshold below." },
                    { key = "priest_fade_threat_threshold", type = "slider", label = "Fade Threat Threshold (%)", min = 40, max = 100, default = 80, tooltip = "Trigger Auto Fade when threat percent reaches this value." },
                    ...
                    { key = "auto_healthstone", type = "checkbox", label = "Auto Healthstone", default = true, tooltip = "Use a Warlock Healthstone when HP drops below the threshold below." },
                    { key = "healthstone_hp_threshold", type = "slider", label = "Healthstone HP (%)", min = 10, max = 60, default = 30, tooltip = "Use Healthstone when self HP falls to this percent." },
                },
            },
        },
    },
