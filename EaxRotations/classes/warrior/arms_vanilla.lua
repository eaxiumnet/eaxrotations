...
-- Change: Classic Vanilla Arms Warrior rotation (no VictoryRush/CommandingShout/SpellReflection)
-- =========================================================================
local __eax_file = "classes/warrior/arms_vanilla.lua"
local __eax_version = "1.1.1"
local __eax_modified = "2026-05-28"
local __eax_change = "Classic Vanilla Arms Warrior rotation"
...
-- ============================================================================
-- What: Classic Vanilla Warrior Arms rotation (Mortal Strike, Slam weaving, no TBC spells)
-- When: Per tick
-- Why: Classic Arms uses Mortal Strike, Overpower, Rend, Execute with Slam filler
