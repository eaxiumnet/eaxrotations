...
-- Change: Classic Vanilla Restoration Shaman rotation
-- =========================================================================
local __eax_file = "classes/shaman/restoration_vanilla.lua"
local __eax_version = "1.1.1"
local __eax_modified = "2026-05-28"
local __eax_change = "Classic Vanilla Restoration Shaman rotation"
...
-- ============================================================================
-- What: Classic Vanilla Shaman Restoration healing rotation with explicit shield checks, mana tools, and totem upkeep
-- When: Per tick
...
local WATER_SHIELD_SPELL = SPELLS.UnavailableClassicShamanShieldB or 33736
...
local function build_state(context)
    ...
    resto_state.bloodlust_ready = me and NS.spell_ready(SPELLS.UnavailableClassicShamanBurst, me, { skip_range = true }) or false
...
local function bloodlust_matches(context, state)
    ...
    local me = context.me or NS.GetPlayer()
    if not me or not NS.spell_ready(SPELLS.UnavailableClassicShamanBurst, me, { skip_range = true }) then return false end
    return true
end
