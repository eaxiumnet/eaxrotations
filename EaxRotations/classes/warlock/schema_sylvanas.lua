...
-- SAFETY: nil-guarded menu references; default fallbacks for all settings. use_fear_cc (default true) added early (PR1) under General for menu availability + spec_kit fallback; tooltip documents PvE suppression (Fear strictly gated to is_pvp in follow-ups). (DECISION: early addition for widget + fallback before spec use; no behavior change.)
