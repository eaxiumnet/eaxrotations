        ...
        sections = {
            {
                ...
                settings = {
                    ...
                    { key = "prot_judgement", type = "checkbox", label = "Judgement", default = false, tooltip = "Judgement to consume seals for damage" },
            ...
            },
            {
                ...
                settings = {
                    ...
                    { key = "prot_avenger_shield", type = "checkbox", label = "Avenger's Shield", default = false, tooltip = "Use Avenger's Shield for pulling and threat" },
                    { key = "prot_avenger_opener", type = "checkbox", label = "Avenger's Shield Pre-Pull", default = false, tooltip = "Cast Avenger's Shield before combat as an opener" },
            ...
            },
            {
                ...
                settings = {
                    ...
                    { key = "prot_hammer_of_wrath", type = "checkbox", label = "Hammer of Wrath", default = false, tooltip = "Execute-range Hammer of Wrath" },
