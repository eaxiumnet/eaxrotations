...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-576%2F576%20passing-brightgreen" alt="576/576 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 615 test suites (576 rotation + 39 leveling)
```
...
| 🧪 **615 Test Suites** | 576 rotation + 39 leveling registered; 576 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 576 rotation suites
...
Run the full rotation regression suite (**576 suites**):
