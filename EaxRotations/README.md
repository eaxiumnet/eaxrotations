...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-485%2F485%20passing-brightgreen" alt="485/485 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 516 test suites (485 rotation + 31 leveling)
```
...
| 🧪 **516 Test Suites** | 485 rotation + 31 leveling registered; 485 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 485 rotation suites
...
Run the full rotation regression suite (**485 suites**):
