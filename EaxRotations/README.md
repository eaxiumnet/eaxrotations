...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-587%2F587%20passing-brightgreen" alt="587/587 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 626 test suites (587 rotation + 39 leveling)
```
...
| 🧪 **626 Test Suites** | 587 rotation + 39 leveling registered; 587 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 587 rotation suites
...
Run the full rotation regression suite (**587 suites**):
