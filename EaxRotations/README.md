...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-471%2F471%20passing-brightgreen" alt="471/471 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 502 test suites (471 rotation + 31 leveling)
```
...
| 🧪 **502 Test Suites** | 471 rotation + 31 leveling registered; 471 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 471 rotation suites
...
Run the full rotation regression suite (**471 suites**):
