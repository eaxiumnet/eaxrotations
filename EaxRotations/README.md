...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-604%2F604%20passing-brightgreen" alt="604/604 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 652 test suites (604 rotation + 48 leveling)
```
...
| 🧪 **652 Test Suites** | 604 rotation + 48 leveling registered; 604 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 604 rotation suites
...
Run the full rotation regression suite (**604 suites**):
