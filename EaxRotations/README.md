...
<p align="center">
  <img src="https://img.shields.io/badge/version-2.22.0-blue" alt="Version 2.22.0">
  <img src="https://img.shields.io/badge/specs-29%20%2B%209%20leveling-brightgreen" alt="29 Specs + 9 Leveling">
  <img src="https://img.shields.io/badge/tests-476%2F476%20passing-brightgreen" alt="476/476 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 507 test suites (476 rotation + 31 leveling)
```
...
| 🧪 **507 Test Suites** | 476 rotation + 31 leveling registered; 476 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 476 rotation suites
    ├── run_leveling_tests.lua    # 31 leveling suites
...
Run the full rotation regression suite (**476 suites**):

```bash
lua EaxRotations/tests/run_rotation_tests.lua
```

Run the leveling test suite (**31 suites**):
