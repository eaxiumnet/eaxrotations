...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-354%2F354%20passing-success" alt="356/356 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 356 regression test suites
```
...
| 🧪 **356 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 356 rotation suites
...
Run the full rotation regression suite (**356 suites**):
