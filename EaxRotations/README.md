...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-354%2F354%20passing-success" alt="361/361 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 361 regression test suites
```
...
| 🧪 **361 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 361 rotation suites
...
Run the full rotation regression suite (**361 suites**):
