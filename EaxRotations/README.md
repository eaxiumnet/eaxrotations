...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-373%2F373%20passing-success" alt="389/389 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 389 regression test suites
```
...
| 🧪 **389 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 389 rotation suites
    ├── run_leveling_tests.lua    # 30 leveling suites
...
Run the full rotation regression suite (**389 suites**):

```bash
lua EaxRotations/tests/run_rotation_tests.lua
```

Run the leveling test suite (**30 suites**):
