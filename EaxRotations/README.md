...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-373%2F373%20passing-success" alt="377/377 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 377 regression test suites
```
...
| 🧪 **377 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 377 rotation suites
...
Run the full rotation regression suite (**377 suites**):
