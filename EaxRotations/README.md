...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-593%2F593%20passing-brightgreen" alt="593/593 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 632 test suites (593 rotation + 39 leveling)
```
...
| 🧪 **632 Test Suites** | 593 rotation + 39 leveling registered; 593 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 593 rotation suites
...
Run the full rotation regression suite (**593 suites**):
