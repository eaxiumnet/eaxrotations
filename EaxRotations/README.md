...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-589%2F589%20passing-brightgreen" alt="589/589 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 628 test suites (589 rotation + 39 leveling)
```
...
| 🧪 **628 Test Suites** | 589 rotation + 39 leveling registered; 589 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 589 rotation suites
...
Run the full rotation regression suite (**589 suites**):
