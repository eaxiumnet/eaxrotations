...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-373%2F373%20passing-success" alt="376/376 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 376 regression test suites
```
...
| 🧪 **376 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 376 rotation suites
...
Run the full rotation regression suite (**376 suites**):
