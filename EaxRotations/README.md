...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-354%2F354%20passing-success" alt="364/364 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 364 regression test suites
```
...
| 🧪 **364 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 364 rotation suites
...
Run the full rotation regression suite (**364 suites**):
