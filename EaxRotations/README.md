...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-586%2F586%20passing-brightgreen" alt="586/586 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 625 test suites (586 rotation + 39 leveling)
```
...
| 🧪 **625 Test Suites** | 586 rotation + 39 leveling registered; 586 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 586 rotation suites
...
Run the full rotation regression suite (**586 suites**):
