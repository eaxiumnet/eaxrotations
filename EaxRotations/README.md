...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-599%2F599%20passing-brightgreen" alt="599/599 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 647 test suites (599 rotation + 48 leveling)
```
...
| 🧪 **647 Test Suites** | 599 rotation + 48 leveling registered; 599 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 599 rotation suites
...
Run the full rotation regression suite (**599 suites**):
