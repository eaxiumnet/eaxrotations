...
scripts/
  EaxRotations/
    ...
    tests/                  # 637 test suites (597 rotation + 40 leveling)
```
...
| 🧪 **637 Test Suites** | 597 rotation + 40 leveling registered; 597 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ...
    ├── run_leveling_tests.lua    # 40 leveling suites
...
Run the leveling test suite (**40 suites**):
