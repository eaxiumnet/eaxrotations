...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-602%2F602%20passing-brightgreen" alt="602/602 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 650 test suites (602 rotation + 48 leveling)
```
...
| 🧪 **650 Test Suites** | 602 rotation + 48 leveling registered; 602 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 602 rotation suites
...
Run the full rotation regression suite (**602 suites**):
