...
<p align="center">
  <img src="https://img.shields.io/badge/version-2.21.0-blue" alt="Version 2.21.0">
  <img src="https://img.shields.io/badge/specs-29%20%2B%209%20leveling-brightgreen" alt="29 Specs + 9 Leveling">
  <img src="https://img.shields.io/badge/tests-475%2F475%20passing-brightgreen" alt="475/475 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 506 test suites (475 rotation + 31 leveling)
```
...
| 🧪 **506 Test Suites** | 475 rotation + 31 leveling registered; 475 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 475 rotation suites
...
Run the full rotation regression suite (**475 suites**):
