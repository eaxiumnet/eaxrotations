...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-597%2F597%20passing-brightgreen" alt="597/597 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 643 test suites (597 rotation + 46 leveling)
```
...
| 🧪 **643 Test Suites** | 597 rotation + 46 leveling registered; 597 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ...
    ├── run_leveling_tests.lua    # 46 leveling suites
...
Run the full rotation regression suite (**597 suites**):

```bash
lua EaxRotations/tests/run_rotation_tests.lua
```

Run the leveling test suite (**46 suites**):
