...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-354%2F354%20passing-success" alt="357/357 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 357 regression test suites
```
...
| 🧪 **357 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 357 rotation suites
...
Run the full rotation regression suite (**357 suites**):
