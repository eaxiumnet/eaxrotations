...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-373%2F373%20passing-success" alt="379/379 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 379 regression test suites
```
...
| 🧪 **379 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 379 rotation suites
...
Run the full rotation regression suite (**379 suites**):
