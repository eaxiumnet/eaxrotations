...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-582%2F582%20passing-brightgreen" alt="582/582 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 621 test suites (582 rotation + 39 leveling)
```
...
| 🧪 **621 Test Suites** | 582 rotation + 39 leveling registered; 582 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 582 rotation suites
...
Run the full rotation regression suite (**582 suites**):
