...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-488%2F488%20passing-brightgreen" alt="488/488 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 519 test suites (488 rotation + 31 leveling)
```
...
| 🧪 **519 Test Suites** | 488 rotation + 31 leveling registered; 488 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 488 rotation suites
...
Run the full rotation regression suite (**488 suites**):
