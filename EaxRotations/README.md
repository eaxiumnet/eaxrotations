...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-342%2F342%20passing-success" alt="343/343 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 343 regression test suites
```
...
| 🧪 **343 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 343 rotation suites
...
Run the full rotation regression suite (**343 suites**):
