...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-577%2F577%20passing-brightgreen" alt="577/577 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 616 test suites (577 rotation + 39 leveling)
```
...
| 🧪 **616 Test Suites** | 577 rotation + 39 leveling registered; 577 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 577 rotation suites
...
Run the full rotation regression suite (**577 suites**):
