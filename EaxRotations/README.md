...
<p align="center">
  <img src="https://img.shields.io/badge/version-2.18.0-blue" alt="Version 2.18.0">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 398 regression test suites
```
...
| 🧪 **398 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 398 rotation suites
...
Run the full rotation regression suite (**398 suites**):
