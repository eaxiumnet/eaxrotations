...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-568%2F568%20passing-brightgreen" alt="568/568 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 607 test suites (568 rotation + 39 leveling)
```
...
| 🧪 **607 Test Suites** | 568 rotation + 39 leveling registered; 568 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 568 rotation suites
...
Run the full rotation regression suite (**568 suites**):
