...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-373%2F373%20passing-success" alt="375/375 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 375 regression test suites
```
...
| 🧪 **375 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 375 rotation suites
...
Run the full rotation regression suite (**375 suites**):
