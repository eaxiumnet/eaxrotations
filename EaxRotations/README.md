...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-373%2F373%20passing-success" alt="378/378 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 378 regression test suites
```
...
| 🧪 **378 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 378 rotation suites
...
Run the full rotation regression suite (**378 suites**):
