...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-477%2F477%20passing-brightgreen" alt="477/477 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 508 test suites (477 rotation + 31 leveling)
```
...
| 🧪 **508 Test Suites** | 477 rotation + 31 leveling registered; 477 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 477 rotation suites
...
Run the full rotation regression suite (**477 suites**):
