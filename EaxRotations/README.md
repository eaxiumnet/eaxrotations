...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-252%2F252%20passing-success" alt="333/333 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 333 regression test suites
```
...
| 🧪 **333 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 333 rotation suites
...
Run the full rotation regression suite (**333 suites**):
