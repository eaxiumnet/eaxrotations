...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-600%2F600%20passing-brightgreen" alt="600/600 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 648 test suites (600 rotation + 48 leveling)
```
...
| 🧪 **648 Test Suites** | 600 rotation + 48 leveling registered; 600 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 600 rotation suites
...
Run the full rotation regression suite (**600 suites**):
