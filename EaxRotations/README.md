...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-603%2F603%20passing-brightgreen" alt="603/603 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 651 test suites (603 rotation + 48 leveling)
```
...
| 🧪 **651 Test Suites** | 603 rotation + 48 leveling registered; 603 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 603 rotation suites
...
Run the full rotation regression suite (**603 suites**):
