...
scripts/
  EaxRotations/
    ...
    tests/                  # 640 test suites (597 rotation + 43 leveling)
```
...
| 🧪 **640 Test Suites** | 597 rotation + 43 leveling registered; 597 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ...
    ├── run_leveling_tests.lua    # 43 leveling suites
...
Run the leveling test suite (**43 suites**):
