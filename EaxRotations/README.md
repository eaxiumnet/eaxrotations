...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-354%2F354%20passing-success" alt="362/362 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 362 regression test suites
```
...
| 🧪 **362 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 362 rotation suites
...
Run the full rotation regression suite (**362 suites**):
