...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-354%2F354%20passing-success" alt="365/365 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 365 regression test suites
```
...
| 🧪 **365 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 365 rotation suites
...
Run the full rotation regression suite (**365 suites**):
