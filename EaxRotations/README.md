...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-581%2F581%20passing-brightgreen" alt="581/581 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 620 test suites (581 rotation + 39 leveling)
```
...
| 🧪 **620 Test Suites** | 581 rotation + 39 leveling registered; 581 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 581 rotation suites
...
Run the full rotation regression suite (**581 suites**):
