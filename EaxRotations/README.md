...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-354%2F354%20passing-success" alt="355/355 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 355 regression test suites
```
...
| 🧪 **355 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 355 rotation suites
...
Run the full rotation regression suite (**355 suites**):
