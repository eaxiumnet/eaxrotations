...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-373%2F373%20passing-success" alt="388/388 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 388 regression test suites
```
...
| 🧪 **388 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 388 rotation suites
    ├── run_leveling_tests.lua    # 29 leveling suites
...
Run the full rotation regression suite (**388 suites**):

```bash
lua EaxRotations/tests/run_rotation_tests.lua
```

Run the leveling test suite (**29 suites**):
