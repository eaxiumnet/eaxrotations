...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-350%2F350%20passing-success" alt="352/352 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 352 regression test suites
```
...
| 🧪 **352 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 352 rotation suites
...
Run the full rotation regression suite (**352 suites**):
