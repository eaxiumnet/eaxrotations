...
| 🧪 **502 Test Suites** | 469 rotation + 33 leveling registered; 466 rotation passing at runtime (all rotation suites green; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
