...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-373%2F373%20passing-success" alt="390/390 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 390 regression test suites
```
...
| 🧪 **390 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 390 rotation suites
...
Run the full rotation regression suite (**390 suites**):
