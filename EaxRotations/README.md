...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-373%2F373%20passing-success" alt="380/380 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 380 regression test suites
```
...
| 🧪 **380 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 380 rotation suites
...
Run the full rotation regression suite (**380 suites**):
