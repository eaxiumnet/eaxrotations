...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-591%2F591%20passing-brightgreen" alt="591/591 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 630 test suites (591 rotation + 39 leveling)
```
...
| 🧪 **630 Test Suites** | 591 rotation + 39 leveling registered; 591 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 591 rotation suites
...
Run the full rotation regression suite (**591 suites**):
