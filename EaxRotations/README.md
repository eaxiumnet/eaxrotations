...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-585%2F585%20passing-brightgreen" alt="585/585 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 624 test suites (585 rotation + 39 leveling)
```
...
| 🧪 **624 Test Suites** | 585 rotation + 39 leveling registered; 585 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 585 rotation suites
...
Run the full rotation regression suite (**585 suites**):
