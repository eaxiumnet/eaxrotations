...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-472%2F472%20passing-brightgreen" alt="472/472 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 503 test suites (472 rotation + 31 leveling)
```
...
| 🧪 **503 Test Suites** | 472 rotation + 31 leveling registered; 472 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
