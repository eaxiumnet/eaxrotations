...
| Status | Files | Count |
|--------|-------|-------|
| Converted | `arms_sylvanas.lua`, `fury_sylvanas.lua`, `protection_sylvanas.lua`, `kebab_sylvanas.lua`, `balance_sylvanas.lua`, `cat_sylvanas.lua`, `bear_sylvanas.lua`, `caster_sylvanas.lua`, `resto_sylvanas.lua` | 9 |
| Pending | all other spec + leveling files | 32 |
