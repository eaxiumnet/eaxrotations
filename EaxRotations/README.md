...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-579%2F579%20passing-brightgreen" alt="579/579 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 618 test suites (579 rotation + 39 leveling)
```
...
| 🧪 **618 Test Suites** | 579 rotation + 39 leveling registered; 579 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 579 rotation suites
...
Run the full rotation regression suite (**579 suites**):
