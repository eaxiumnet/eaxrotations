...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-373%2F373%20passing-success" alt="391/391 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 391 regression test suites
```
...
| 🧪 **391 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 391 rotation suites
...
Run the full rotation regression suite (**391 suites**):
