...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-489%2F489%20passing-brightgreen" alt="489/489 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 520 test suites (489 rotation + 31 leveling)
```
...
| 🧪 **520 Test Suites** | 489 rotation + 31 leveling registered; 489 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 489 rotation suites
...
Run the full rotation regression suite (**489 suites**):
