...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-373%2F373%20passing-success" alt="384/384 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 384 regression test suites
```
...
| 🧪 **384 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 384 rotation suites
    ├── run_leveling_tests.lua    # 25 leveling suites
...
Run the full rotation regression suite (**384 suites**):

```bash
lua EaxRotations/tests/run_rotation_tests.lua
```

Run the leveling test suite (**25 suites**):
