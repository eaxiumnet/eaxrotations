...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-596%2F596%20passing-brightgreen" alt="596/596 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 635 test suites (596 rotation + 39 leveling)
```
...
| 🧪 **635 Test Suites** | 596 rotation + 39 leveling registered; 596 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 596 rotation suites
...
Run the full rotation regression suite (**596 suites**):
