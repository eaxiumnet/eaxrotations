...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-578%2F578%20passing-brightgreen" alt="578/578 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 617 test suites (578 rotation + 39 leveling)
```
...
| 🧪 **617 Test Suites** | 578 rotation + 39 leveling registered; 578 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 578 rotation suites
...
Run the full rotation regression suite (**578 suites**):
