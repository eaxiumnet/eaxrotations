...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-481%2F481%20passing-brightgreen" alt="481/481 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 512 test suites (481 rotation + 31 leveling)
```
...
| 🧪 **512 Test Suites** | 481 rotation + 31 leveling registered; 481 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 481 rotation suites
...
Run the full rotation regression suite (**481 suites**):
