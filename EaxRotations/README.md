...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-566%2F566%20passing-brightgreen" alt="566/566 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 605 test suites (566 rotation + 39 leveling)
```
...
| 🧪 **605 Test Suites** | 566 rotation + 39 leveling registered; 566 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 566 rotation suites
...
Run the full rotation regression suite (**566 suites**):
