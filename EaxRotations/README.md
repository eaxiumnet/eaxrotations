...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-370%2F370%20passing-success" alt="370/370 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 370 regression test suites
```
...
| 🧪 **370 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 370 rotation suites
...
Run the full rotation regression suite (**370 suites**):
