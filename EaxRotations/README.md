...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-373%2F373%20passing-success" alt="383/383 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 383 regression test suites
```
...
| 🧪 **383 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 383 rotation suites
    ├── run_leveling_tests.lua    # 24 leveling suites
...
Run the full rotation regression suite (**383 suites**):

```bash
lua EaxRotations/tests/run_rotation_tests.lua
```

Run the leveling test suite (**24 suites**):
