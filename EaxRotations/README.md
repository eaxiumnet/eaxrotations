...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-373%2F373%20passing-success" alt="393/393 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 393 regression test suites
```
...
| 🧪 **393 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 393 rotation suites
...
Run the full rotation regression suite (**393 suites**):
