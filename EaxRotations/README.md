...
scripts/
  EaxRotations/
    ...
    tests/                  # 636 test suites (597 rotation + 39 leveling)
```
...
| 🧪 **636 Test Suites** | 597 rotation + 39 leveling registered; 597 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
