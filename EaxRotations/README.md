...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-354%2F354%20passing-success" alt="358/358 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 358 regression test suites
```
...
| 🧪 **358 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 358 rotation suites
...
Run the full rotation regression suite (**358 suites**):
