...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-598%2F598%20passing-brightgreen" alt="598/598 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 646 test suites (598 rotation + 48 leveling)
```
...
| 🧪 **646 Test Suites** | 598 rotation + 48 leveling registered; 598 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 598 rotation suites
...
Run the full rotation regression suite (**598 suites**):
