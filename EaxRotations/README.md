...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-571%2F571%20passing-brightgreen" alt="571/571 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 610 test suites (571 rotation + 39 leveling)
```
...
| 🧪 **610 Test Suites** | 571 rotation + 39 leveling registered; 571 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 571 rotation suites
...
Run the full rotation regression suite (**571 suites**):
