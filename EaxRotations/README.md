...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-369%2F369%20passing-success" alt="369/369 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 369 regression test suites
```
...
| 🧪 **369 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 369 rotation suites
...
Run the full rotation regression suite (**369 suites**):
