...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-373%2F373%20passing-success" alt="387/387 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 387 regression test suites
```
...
| 🧪 **387 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 387 rotation suites
    ├── run_leveling_tests.lua    # 28 leveling suites
...
Run the full rotation regression suite (**387 suites**):

```bash
lua EaxRotations/tests/run_rotation_tests.lua
```

Run the leveling test suite (**28 suites**):
