...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-482%2F482%20passing-brightgreen" alt="482/482 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 513 test suites (482 rotation + 31 leveling)
```
...
| 🧪 **513 Test Suites** | 482 rotation + 31 leveling registered; 482 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 482 rotation suites
...
Run the full rotation regression suite (**482 suites**):
