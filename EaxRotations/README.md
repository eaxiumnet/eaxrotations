...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-373%2F373%20passing-success" alt="381/381 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 381 regression test suites
```
...
| 🧪 **381 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 381 rotation suites
    ├── run_leveling_tests.lua    # 22 leveling suites
...
Run the full rotation regression suite (**381 suites**):

```bash
lua EaxRotations/tests/run_rotation_tests.lua
```

Run the leveling test suite (**22 suites**):
