...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-337%2F337%20passing-success" alt="337/337 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 337 regression test suites
```
...
| 🧪 **337 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 337 rotation suites
...
Run the full rotation regression suite (**337 suites**):
