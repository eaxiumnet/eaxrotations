...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-492%2F492%20passing-brightgreen" alt="492/492 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 524 test suites (492 rotation + 32 leveling)
```
...
| 🧪 **524 Test Suites** | 492 rotation + 32 leveling registered; 492 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 492 rotation suites
...
Run the full rotation regression suite (**492 suites**):
