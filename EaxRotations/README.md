...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-350%2F350%20passing-success" alt="354/354 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 354 regression test suites
```
...
| 🧪 **354 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 354 rotation suites
...
Run the full rotation regression suite (**354 suites**):
