...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-373%2F373%20passing-success" alt="386/386 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 386 regression test suites
```
...
| 🧪 **386 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 386 rotation suites
    ├── run_leveling_tests.lua    # 27 leveling suites
...
Run the full rotation regression suite (**386 suites**):

```bash
lua EaxRotations/tests/run_rotation_tests.lua
```

Run the leveling test suite (**27 suites**):
