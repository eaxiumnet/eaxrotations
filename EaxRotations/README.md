...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-348%2F348%20passing-success" alt="350/350 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 350 regression test suites
```
...
| 🧪 **350 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 350 rotation suites
...
Run the full rotation regression suite (**350 suites**):
