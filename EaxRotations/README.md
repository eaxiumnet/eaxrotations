...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-592%2F592%20passing-brightgreen" alt="592/592 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 631 test suites (592 rotation + 39 leveling)
```
...
| 🧪 **631 Test Suites** | 592 rotation + 39 leveling registered; 592 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 592 rotation suites
...
Run the full rotation regression suite (**592 suites**):
