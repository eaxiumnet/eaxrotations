...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-337%2F337%20passing-success" alt="338/338 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 338 regression test suites
```
...
| 🧪 **338 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 338 rotation suites
...
Run the full rotation regression suite (**338 suites**):
