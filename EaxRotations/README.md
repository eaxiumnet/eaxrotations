...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-346%2F346%20passing-success" alt="347/347 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 347 regression test suites
```
...
| 🧪 **347 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 347 rotation suites
...
Run the full rotation regression suite (**347 suites**):
