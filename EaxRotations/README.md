...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-372%2F372%20passing-success" alt="372/372 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 372 regression test suites
```
...
| 🧪 **372 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 372 rotation suites
...
Run the full rotation regression suite (**372 suites**):
