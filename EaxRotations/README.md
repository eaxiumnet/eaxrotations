...
scripts/
  EaxRotations/
    ...
    tests/                  # 348 regression test suites
```
...
| 🧪 **348 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 348 rotation suites
...
Run the full rotation regression suite (**348 suites**):
