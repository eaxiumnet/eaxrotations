...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-252%2F252%20passing-success" alt="336/336 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 336 regression test suites
```
...
| 🧪 **336 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 336 rotation suites
...
Run the full rotation regression suite (**336 suites**):
