...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-350%2F350%20passing-success" alt="353/353 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 353 regression test suites
```
...
| 🧪 **353 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 353 rotation suites
...
Run the full rotation regression suite (**353 suites**):
