...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-590%2F590%20passing-brightgreen" alt="590/590 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 629 test suites (590 rotation + 39 leveling)
```
...
| 🧪 **629 Test Suites** | 590 rotation + 39 leveling registered; 590 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 590 rotation suites
...
Run the full rotation regression suite (**590 suites**):
