...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-580%2F580%20passing-brightgreen" alt="580/580 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 619 test suites (580 rotation + 39 leveling)
```
...
| 🧪 **619 Test Suites** | 580 rotation + 39 leveling registered; 580 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 580 rotation suites
...
Run the full rotation regression suite (**580 suites**):
