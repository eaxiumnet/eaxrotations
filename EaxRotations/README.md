...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-373%2F373%20passing-success" alt="382/382 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 382 regression test suites
```
...
| 🧪 **382 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 382 rotation suites
    ├── run_leveling_tests.lua    # 23 leveling suites
...
Run the full rotation regression suite (**382 suites**):

```bash
lua EaxRotations/tests/run_rotation_tests.lua
```

Run the leveling test suite (**23 suites**):
