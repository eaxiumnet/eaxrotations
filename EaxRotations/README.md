...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-371%2F371%20passing-success" alt="371/371 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 371 regression test suites
```
...
| 🧪 **371 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 371 rotation suites
...
Run the full rotation regression suite (**371 suites**):
