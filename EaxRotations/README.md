...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-373%2F373%20passing-success" alt="385/385 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 385 regression test suites
```
...
| 🧪 **385 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 385 rotation suites
    ├── run_leveling_tests.lua    # 26 leveling suites
...
Run the full rotation regression suite (**385 suites**):

```bash
lua EaxRotations/tests/run_rotation_tests.lua
```

Run the leveling test suite (**26 suites**):
