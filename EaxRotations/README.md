...
scripts/
  EaxRotations/
    ...
    tests/                  # 644 test suites (597 rotation + 47 leveling)
```
...
| 🧪 **644 Test Suites** | 597 rotation + 47 leveling registered; 597 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ...
    ├── run_leveling_tests.lua    # 47 leveling suites
...
Run the leveling test suite (**47 suites**):
