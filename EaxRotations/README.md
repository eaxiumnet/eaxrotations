...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-354%2F354%20passing-success" alt="366/366 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 366 regression test suites
```
...
| 🧪 **366 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 366 rotation suites
...
Run the full rotation regression suite (**366 suites**):
