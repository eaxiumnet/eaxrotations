...
scripts/
  EaxRotations/
    ...
    tests/                  # 373 regression test suites
```
...
| 🧪 **373 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 373 rotation suites
...
Run the full rotation regression suite (**373 suites**):
