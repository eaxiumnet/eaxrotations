...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-572%2F572%20passing-brightgreen" alt="572/572 Tests Passing (rotation suite fully green)">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 611 test suites (572 rotation + 39 leveling)
```
...
| 🧪 **611 Test Suites** | 572 rotation + 39 leveling registered; 572 rotation passing at runtime (all rotation suites green incl. the 3 `check_*` static-analysis audits; `test_sod_source_audit` self-provisions its `.omo/evidence` via the tracked generator) |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 572 rotation suites
...
Run the full rotation regression suite (**572 suites**):
