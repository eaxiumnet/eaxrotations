...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-340%2F340%20passing-success" alt="340/340 Tests Passing">
...
scripts/
  EaxRotations/
    ...
    tests/                  # 339 regression test suites
```
...
| 🧪 **339 Regression Tests** | All rotation + leveling suites pass with zero failures |
...
└── tests/                  # Regression test suite
    ├── run_rotation_tests.lua    # 339 rotation suites
...
Run the full rotation regression suite (**339 suites**):
