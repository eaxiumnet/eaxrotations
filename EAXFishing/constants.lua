...
constants.OBJECTS = {
    ...
    -- TBC Classic Anniversary (2.5.5) pool names.
    -- Only pools that exist in TBC-era content (Vanilla + Outland).
    -- WotLK/Cata/MoP/SL/DF pools removed — they don't exist in the 2.5.5 client.
    POOLS = {
        -- Vanilla (Eastern Kingdoms / Kalimdor)
        ...
        -- TBC (Outland)
        ["School of Spotted Feltail"] = true,   -- Zangarmarsh
        ["School of Darter"] = true,            -- Terokkar
        ["School of Highland Mixed Fish"] = true, -- Terokkar
        ["Steam Pump Flotsam"] = true,          -- Zangarmarsh
        ["School of Sporefish"] = true,         -- Zangarmarsh
        ["Mudfish School"] = true,              -- Nagrand
        ["Bluefish School"] = true,             -- Nagrand
        ["School of Goldenscale Vendorfish"] = true, -- Terokkar
    }
}
