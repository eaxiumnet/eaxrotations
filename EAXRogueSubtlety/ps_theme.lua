...
ps.col = {
    panel        = c(  8,  7, 10, 252),
    panel_deep   = c(  4,  4,  6, 240),
    border_glow  = c(200,180,220, 220),
    border_dim   = c( 90, 80, 20, 160),
    accent       = c(180,160,200, 255),
    accent_mid   = c(180,160, 30, 255),
    text_on      = c(220,200,240, 255),
    text_off     = c(100, 90, 25, 255),
    transparent  = c(  0,   0,   0,   0),
}

local STAR_R, STAR_G, STAR_B = 180, 160, 200
local DUST_R, DUST_G, DUST_B = 180, 160, 20
