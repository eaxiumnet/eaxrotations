-- menu.lua | Eax Rogue Subtlety | TBC
...
function menu.render()
    ...
    root_tree:render("Eax's Rogue Subtlety", function()
        ...
        main_tree:render("Rotation", function()
            ps.header("Rotation")
            menu.use_backstab:render("Backstab", "")
            menu.use_shadow_dance:render("Shadow Dance", "")
            menu.use_ambush:render("Ambush", "")
            menu.use_garrote:render("Garrote", "")
            menu.use_rupture:render("Rupture", "")
            menu.use_preparation:render("Preparation", "")
