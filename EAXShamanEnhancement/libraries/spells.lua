-- Eax Shaman Enhancement | spells.lua
-- TBC Spell ID tables for Enhancement Shaman.
...
spells.BUFF_SHAMANISTIC_FOCUS = { 43339 }
spells.BUFF_FLURRY = { 16280 }
spells.BUFF_BERSERKING = { 26297 }
spells.BUFF_BLOODLUST = { 2825, 32182 }
spells.BUFF_WINDFURY_WEAPON = { 8232, 8235, 10486, 16362, 25505 }
spells.BUFF_FLAMETONGUE_WEAPON = { 8024, 8027, 8030, 16339, 16341, 16342, 25489, 25500 }

-- Debuffs
spells.DEBUFF_FLAME_SHOCK = { 8050, 8052, 8053, 10447, 10448, 29228, 25457 }
spells.DEBUFF_STORMSTRIKE = { 17364 }
