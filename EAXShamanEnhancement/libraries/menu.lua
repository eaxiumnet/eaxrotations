...
function menu.render()
    ...
    root_tree:render("Eax's Shaman Enhancement", function()
        ...
        main_tree:render("Eax's Rotation Settings", function()
            ...
            menu.auto_totems:render("Auto Totems", "Keep Windfury and support totems active")
            menu.auto_totem_windfury:render("Windfury Totem", "Refresh Windfury for melee procs")
            menu.use_totem_twist:render("Totem Twist (Optional)", "Advanced raid behavior: alternate Windfury with Grace of Air when desired")
