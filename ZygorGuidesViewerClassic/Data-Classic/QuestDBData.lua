ZGV.Quest_Cache_Accept_Alliance = {
	...
	["LEVELING\\Duskwood (35-35)"] = {
		{ids="1042,1043", cond_if=[[completedq(1041)]]},
	...
	["LEVELING\\Dwarf & Gnome Starter (1-13)"] = {
		...
		{ids="1599,77666,1715,6661,6662,1688,1689", cond_if=[[Gnome Warlock]]},
	...
	["LEVELING\\Loch Modan (17-18)"] = {
		...
		{ids="436,297,298,385,257,258,2038,250,199,301"},
	},
	...
	["LEVELING\\Redridge Mountains (27-28)"] = {
		...
		{ids="128,126,180,219", cond_if=[[not hardcore()]]},
	...
	["LEVELING\\Starter Guides (1-11)\\Night Elf Starter (1-11)"] = {
		...
		{ids="3118,2241,2242", cond_if=[[NightElf Rogue]]},
		...
		{ids="456,4495,458,457,459,916,3519,917,3521,920,921,3522,928,2159,488,997,475,932,2438,929,918,919,922,476,489,2459,933,4161,930,7383,487,937,931,938,940,923,952,2518,935,2520"},
	},
...
ZGV.Quest_Cache_Turnin_Alliance = {
	...
	["LEVELING\\Dwarf & Gnome Starter (1-13)"] = {
		...
		{ids="3115,1599,77666,6661,6662,1715,1688,1689", cond_if=[[Gnome Warlock]]},
		{ids="1638,1639,1640,1665", cond_if=[[(Dwarf or Gnome) and Warrior]]},
	...
	["LEVELING\\Loch Modan (17-18)"] = {
		...
		{ids="436,297,257,258,250,199,2038,385,298,301"},
	},
	["LEVELING\\Mage Class Quests"] = {
	...
	["LEVELING\\Redridge Mountains (27-28)"] = {
		...
		{ids="373,389,391,387,388,386,377", cond_if=[[guideflag("Stockflag")]]},
	...
	["LEVELING\\Starter Guides (1-11)\\Night Elf Starter (1-11)"] = {
		...
		{ids="3116", cond_if=[[NightElf Warrior]]},
		{ids="456,458,4495,916,457,459,3519,917,920,3521,3522,921,2159,928,997,918,919,475,488,476,2438,929,4161,489,932,2459,933,938,937,922,940,7383,931,930,487,923,935,2518,2520"},
	},
	["LEVELING\\Stonetalon Mountains (23-24)"] = {
	...
	["LEVELING\\Un'Goro Crater (50-50)"] = {
		{ids="648,836,2767", cond_if=[[readyq(648) or readyq(836) or readyq(2767)]]},
...
ZGV.Quest_Cache_Accept_Horde = {
	...
	["LEVELING\\Ashenvale (27-28)"] = {
		...
		{ids="6504", cond_if=[[(itemcount(16642) > 0) and (itemcount(16643) > 0) and (itemcount(16644) > 0)]]},
		{ids="23,23", cond_if=[[itemcount(16303) > 0]]},
		{ids="6922", cond_if=[[guideflag("BFDflag")]]},
		{ids="6383,25,6441,6503,6544,6482,1918,824,1196,1131"},
	},
	["LEVELING\\Azshara (52-52)"] = {
	...
	["LEVELING\\Badlands (39-40)"] = {
		{ids="715,716", cond_if=[[(itemcount(3823) > 0 and itemcount(929) > 0) or itemcount(2868) > 0]]},
		{ids="705", cond_if=[[itemcount(4611) >= 9]]},
		{ids="1559", cond_if=[[completedq(705) and hasprof("Engineering",1)]]},
		{ids="714", cond_if=[[itemcount(4389) > 0 and completedq(713)]]},
		{ids="713", cond_if=[[itemcount(3829) > 0]]},
	...
	["LEVELING\\Orc & Troll Starter (1-12)"] = {
		...
		{ids="77587", cond_if=[[Troll Shaman]]},
	...
	["LEVELING\\Tauren Starter (1-12)"] = {
		...
		{ids="77652,1519,1520,1521,2984,1524,1525,840,1526,1527,842", cond_if=[[Tauren Shaman]]},
	...
	["LEVELING\\The Barrens (12-18)"] = {
		...
		{ids="5727", cond_if=[[not completedq(5727) and guideflag("RFCflag")]]},
		...
		{ids="5726", cond_if=[[not completedq(5726) and guideflag("RFCflag")]]},
		...
		{ids="844,870,869,871,5041,867,1492,848,845,872,887,894,895,865,821,890,892,896,888,903,855,850,851,900,901,902,858,863,1061,3281,881,877,875,905,899,4921,1483,1069,878,3261,880,852"},
	},
	...
	["LEVELING\\Undead Starter (1-14)"] = {
		{ids="1899,1978", cond_if=[[Scourge Rogue and completedq(1886)]]},
		{ids="1963", cond_if=[[Orc Rogue or Troll Rogue]]},
		{ids="1898", cond_if=[[Scourge Rogue and itemcount(7231) > 0]]},
		...
		{ids="363,6321,6323,6322", cond_if=[[Scourge]]},
		...
		{ids="1470,3099,77672,1478,1473,357,1471,371", cond_if=[[Scourge Warlock]]},
...
ZGV.Quest_Cache_Turnin_Horde = {
	...
	["LEVELING\\Ashenvale (27-28)"] = {
		...
		{ids="6382,6503,6544,23,24,6482,25,1918,6441,216,6462,824,1086,1195"},
	},
	["LEVELING\\Azshara (52-52)"] = {
	...
	["LEVELING\\Badlands (39-40)"] = {
		{ids="715,716", cond_if=[[(itemcount(3823) > 0 and itemcount(929) > 0) or itemcount(2868) > 0]]},
		{ids="705", cond_if=[[itemcount(4611) >= 9]]},
		{ids="712,713", cond_if=[[itemcount(3829) > 0]]},
		{ids="714", cond_if=[[itemcount(4389) > 0 and completedq(713)]]},
		{ids="1106,710,1108,703,711,1419,2258"},
	},
	["LEVELING\\Blasted Lands (50-51)"] = {
		{ids="3501", cond_if=[[haveq(3501) or completedq(3501)]]},
	...
	["LEVELING\\Stranglethorn Vale (40-40)"] = {
		...
		{ids="339,340,341,342,338", cond_if=[[haveq(338)]]},
	...
	["LEVELING\\Tauren Starter (1-12)"] = {
		...
		{ids="752,747,753,755,750,780,3376,781,757,763,1656,767,745,771,749,766,761,772,773,833,743,746,751,775,776,744,861,764,765,860"},
	},
	["LEVELING\\The Barrens (12-18)"] = {
		...
		{ids="844,871,1492,819,887,895,890,892,5041,872,845,850,894,900,901,858,869,903,870,867,848,881,902,863,896,3281,905,4921,877,855,851"},
	...
	["LEVELING\\Undead Starter (1-14)"] = {
		...
		{ids="445", cond_if=[[haveq(445) or completedq(445)]]},
		{ids="1898,1899,1978", cond_if=[[Scourge Rogue and completedq(1886)]]},
		{ids="3095,1818,1819,1820", cond_if=[[Scourge Warrior]]},
		...
		{ids="1886", cond_if=[[Scourge Rogue and itemcount(7231) > 0]]},
