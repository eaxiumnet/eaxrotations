...
spells.DEBUFF_TRAUMA = { 12294 }
spells.DEBUFF_DEMORALIZING_ROAR = { 99, 1738, 9490, 9491, 9745, 9746, 10756, 25275 }

-- Warrior debuffs (for FF collision detection)
spells.DEBUFF_SUNDER_ARMOR = { 11597, 11596, 11595, 8380, 7405, 7404, 7403, 7402, 7401, 7925, 7924, 7923, 7922, 7921, 7920, 7386 }
...
-- Survival Instincts (WotLK defensive CD)
