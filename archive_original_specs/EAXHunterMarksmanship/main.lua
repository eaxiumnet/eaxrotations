...
-- FIXED: Corrected try_mend to use proper menu reference
...
-- -- Pet -----------------------------------------------------------------------
-- FIXED: Corrected menu reference from use_mend_pet to use_revive_pet
local function try_revive(me)
    -- FIXED: Add nil guard for menu reference - was using wrong menu key
