-- class_ui_init.lua  (auto-generated for EAXRogueAssassination)
...
local function apply()
    ...
    CLASS_ID = identity.CLASS_IDS.ROGUE
    SPEC_ID = identity.SPEC_IDS.ROGUE_ASSASSINATION
    theme.init(
        CLASS_ID,
        SPEC_ID
    )
...
return { apply = apply, display_name = "Rogue Assassination", class_id = CLASS_ID, spec_id = SPEC_ID }
