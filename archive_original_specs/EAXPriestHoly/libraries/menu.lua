...
menu.flash_heal_hp_pct                  = core.menu.slider_int(10, 100, 50, "eaxpriestholy_flash_heal_hp_pct")  -- Flux: <50% emergency
menu.holy_emergency_hp                   = core.menu.slider_int(5, 50, 30, "eaxpriestholy_emergency_hp")  -- Flux: <30% emergency heals
menu.use_renew                           = core.menu.checkbox(true, "eaxpriestholy_use_renew")
menu.renew_threshold                     = core.menu.slider_int(0, 100, 90, "eaxpriestholy_renew_threshold")  -- Flux: 90% HoT maintenance
menu.renew_refresh_seconds               = core.menu.slider_int(0, 10, 3, "eaxpriestholy_renew_refresh")
menu.holy_prepull_renew                  = core.menu.checkbox(true, "eaxpriestholy_prepull_renew")  -- Flux: pre-pull Renew on tank
...
menu.binding_heal_self_threshold         = core.menu.slider_int(0, 100, 80, "eaxpriestholy_binding_heal_self_threshold")  -- Flux: 80%
menu.binding_heal_target_threshold        = core.menu.slider_int(0, 100, 80, "eaxpriestholy_binding_heal_target_threshold")  -- Flux: 80%
...
menu.holy_aoe_hp                         = core.menu.slider_int(50, 100, 80, "eaxpriestholy_aoe_hp")  -- Flux: 80% for group damage
...
menu.holy_pws_hp                         = core.menu.slider_int(5, 50, 30, "eaxpriestholy_pws_hp")  -- Flux: 30% emergency PW:S
