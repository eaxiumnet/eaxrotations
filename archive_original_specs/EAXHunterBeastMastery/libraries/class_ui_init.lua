-- class_ui_init.lua  (auto-generated for EAXHunterBeastMastery)
...
local function apply()
    ...
    SPEC_ID = identity.SPEC_IDS.HUNTER_BM
    theme.init(
        CLASS_ID,
        SPEC_ID
    )
...
return { apply = apply, display_name = "Hunter BM", class_id = CLASS_ID, spec_id = SPEC_ID }
