...
menu.heroic_strike_rage                   = core.menu.slider_int(20, 100, 50, "simplefury_hs_rage")  -- Flux default: 50
menu.cleave_rage                          = core.menu.slider_int(20, 100, 55, "simplefury_cleave_rage")
menu.use_hs_trick                         = core.menu.checkbox(true, "simplefury_use_hs_trick")  -- Flux HS Trick
...
function menu.render()
    ...
    root_tree:render("Eax's Warrior Fury", function()
        ...
        rotation_tree:render("Rotation", function()
            ...
            menu.heroic_strike_rage:render("HS Min Rage", "Queue above (Flux default: 50)")
