...
menu.use_battle_shout                     = core.menu.checkbox(false, "eaxwarriorprotection_use_battle_shout")
menu.use_commanding_shout                 = core.menu.checkbox(true, "eaxwarriorprotection_use_commanding_shout")
