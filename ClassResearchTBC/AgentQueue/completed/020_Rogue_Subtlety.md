# Job 020 - Rogue Subtlety

Status: completed
Created: 2026-05-19
Completed: 2026-05-20
Runner: C:\newbot\scripts\ClassResearchTBC\AgentQueue\AGENT_RUNNER.md
Checklist: C:\newbot\scripts\ClassResearchTBC\ImplementationChecklists\Rogue_Subtlety_CHECKLIST.md
...
| File | Changes |
|---|---|
| `EaxRotations/classes/rogue/class_sylvanas.lua` | 24 DB2 corrections: Ambush, Backstab, Blind(CD), CloakOfShadows, DeadlyThrow, Envenom, Evasion, Eviscerate, ExposeArmor, Feint, Garrote, Gouge, Hemorrhage, KidneyShot, Kick(+38768), Mutilate, Rupture, Sap, SinisterStrike, SliceAndDice, Sprint, Stealth, Vanish levels + CheapShot power_cost 50→60 |
| `EaxRotations/classes/rogue/subtlety_sylvanas.lua` | Updated Kick fallback IDs; ENERGY_CHEAP_SHOT 40→60 |

- ✅ `luac -p` passes | ✅ Code review cleared
- ✅ 24/24 DB2 corrections | ✅ 25/25 behavioral requirements Present
- ✅ CheapShot energy fixed (50→60 power_cost, 40→60 energy floor)
