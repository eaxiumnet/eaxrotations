--[[
    middleware_manager.lua - Middleware Manager for Priest Discipline
...
--- Setup middleware for Priest Discipline
...
function middleware_manager.setup(menu, spells)
    ...
    print("[EAX Discipline] Middleware registered: " .. middleware.count() .. " items")
end
