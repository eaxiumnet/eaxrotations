-- class_ui_init.lua  (auto-generated for EAXPriestDiscipline)
...
local function apply()
    ...
    SPEC_ID = identity.SPEC_IDS.PRIEST_DISCIPLINE
    theme.init(
        CLASS_ID,
        SPEC_ID
    )
...
return { apply = apply, display_name = "Priest Disc", class_id = CLASS_ID, spec_id = SPEC_ID }
