...
-- -- Palette ------------------------------------------------------------------
ps.col = {
    panel        = c( 14, 14, 18, 252),
    panel_deep   = c(  9,  9, 12, 240),
    border_glow  = c(220,220,255, 220),
    border_dim   = c( 80, 80,100, 160),
    accent       = c(200,200,255, 255),
    accent_mid   = c(140,130,200, 255),
    text_on      = c(240,240,255, 255),
    text_off     = c( 90, 88,110, 255),
    transparent  = c(  0,   0,   0,   0),
}

local STAR_R, STAR_G, STAR_B = 200, 200, 255
local DUST_R, DUST_G, DUST_B = 150, 140, 200
