...
---@field PHYSICAL_DAMAGE number[]
---@field MAGICAL_DAMAGE number[]
...
---@field get_incoming_damage fun(self: nil, target: game_object, deadline_time_in_seconds?: number, is_exception?: boolean): number
--- Check if the current situation is a PvP situation.
---@field is_pvp_situation fun(self: nil, target: game_object): boolean
--- Speculate the auto attack damage.
---@field speculate_auto_attack_damage fun(self: nil, caster: game_object, target: game_object, damage: number, spell_id: number): number
...
---@field speculate_damage fun(self: nil, caster: game_object, target: game_object, damage: number, spell_id: number): number
--- Get incoming damage on a target within a deadline.
---@field get_damage_types fun(self: nil, target: game_object, deadline_time_in_seconds?: number, is_exception?: boolean): damage_types_table
