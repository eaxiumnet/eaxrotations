...
local SPELL = {
    ...
    HealthFunnel    = izi.spell(27259, 11695, 11694, 11693, 3700, 3699, 3698, 755),
...
function M.tick(me, target, enemies)
    ...
    if target then
        ...
        if SPELL.CurseOfDoom:is_learned() and target:debuff_remains({ 30910, 603 }) < DOT_REFRESH then
            if SPELL.CurseOfDoom:cast_safe(target) then return true end
        end
