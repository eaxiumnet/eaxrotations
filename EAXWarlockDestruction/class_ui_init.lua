-- class_ui_init.lua  (auto-generated for EAXWarlockDestruction)
...
local function apply()
    ...
    CLASS_ID = identity.CLASS_IDS.WARLOCK
    SPEC_ID = identity.SPEC_IDS.WARLOCK_DESTRUCTION
    theme.init(
        CLASS_ID,
        SPEC_ID
    )
...
return { apply = apply, display_name = "Warlock Destruction", class_id = CLASS_ID, spec_id = SPEC_ID }
