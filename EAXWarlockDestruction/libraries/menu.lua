...
menu.use_curse_of_agony                = core.menu.checkbox(true, "eaxwarlockdestruction_use_curse_of_agony")
menu.life_tap_hp_pct                   = core.menu.slider_int(10, 80, 60, "eaxwarlockdestruction_life_tap_hp_pct")
...
menu.life_tap_min_hp = core.menu.slider_int(10, 100, 40, "eaxwarlockdestruction_life_tap_min_hp")
menu.mana_potion_pct = core.menu.slider_int(5, 100, 20, "eaxwarlockdestruction_mana_potion_pct")
menu.dark_rune_pct = core.menu.slider_int(5, 100, 15, "eaxwarlockdestruction_dark_rune_pct")

-- Burst & Trinket Automation
menu.auto_burst_enabled = core.menu.checkbox(false, "eaxwarlockdestruction_auto_burst")
menu.burst_on_bloodlust = core.menu.checkbox(true, "eaxwarlockdestruction_burst_bloodlust")
menu.burst_on_pull = core.menu.checkbox(true, "eaxwarlockdestruction_burst_pull")
menu.burst_on_execute = core.menu.checkbox(true, "eaxwarlockdestruction_burst_execute")
menu.burst_in_combat = core.menu.checkbox(false, "eaxwarlockdestruction_burst_always")
menu.cd_min_ttd = core.menu.slider_int(0, 60, 0, "eaxwarlockdestruction_cd_min_ttd")
menu.trinket1_mode = core.menu.combobox(1, "eaxwarlockdestruction_trinket1_mode")
menu.trinket2_mode = core.menu.combobox(1, "eaxwarlockdestruction_trinket2_mode")

-- Dashboard menu items
menu.show_dashboard         = core.menu.checkbox(true, "eaxwarlockdestruction_show_dashboard")
menu.dashboard_opacity      = core.menu.slider_int(50, 255, 190, "eaxwarlockdestruction_dashboard_opacity")
menu.dashboard_scale        = core.menu.slider_float(0.5, 2.0, 1.0, "eaxwarlockdestruction_dashboard_scale")
menu.dashboard_x            = core.menu.slider_int(0, 2000, 20, "eaxwarlockdestruction_dashboard_x")
menu.dashboard_y            = core.menu.slider_int(0, 2000, 200, "eaxwarlockdestruction_dashboard_y")
menu.show_timer_bars = core.menu.checkbox(true, "eaxwarlockdestruction_show_timer_bars")
menu.show_action_history = core.menu.checkbox(true, "eaxwarlockdestruction_show_action_history")
menu.show_energy_tick = core.menu.checkbox(false, "eaxwarlockdestruction_show_energy_tick")
menu.show_combo_points = core.menu.checkbox(false, "eaxwarlockdestruction_show_combo_points")
menu.show_threat_bar = core.menu.checkbox(false, "eaxwarlockdestruction_show_threat_bar")
menu.enable_smart_collapse = core.menu.checkbox(true, "eaxwarlockdestruction_enable_smart_collapse")
...
function menu.render()
    ...
    root_tree:render("Eax's Warlock Destruction", function()
        ...
        rotation_tree:render("Rotation", function()
            ...
            menu.use_curse_of_agony:render("CoA", "Debuff")
        ...
        auto_tree:render("Utility", function()
            ...
            menu.life_tap_hp_pct:render("Life Tap HP %", "Above")
