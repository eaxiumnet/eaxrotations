-- class_ui_init.lua  (auto-generated for EAXMageFire)
...
local function apply()
    ...
    SPEC_ID = identity.SPEC_IDS.MAGE_FIRE
    theme.init(
        CLASS_ID,
        SPEC_ID
    )
...
return { apply = apply, display_name = "Mage Fire", class_id = CLASS_ID, spec_id = SPEC_ID }
