-- class_ui_init.lua  (auto-generated for EAXPaladinProtection)
...
local function apply()
    ...
    CLASS_ID = identity.CLASS_IDS.PALADIN
    SPEC_ID = identity.SPEC_IDS.PALADIN_PROT
    theme.init(
        CLASS_ID,
        SPEC_ID
    )
...
return { apply = apply, display_name = "Paladin Prot", class_id = CLASS_ID, spec_id = SPEC_ID }
