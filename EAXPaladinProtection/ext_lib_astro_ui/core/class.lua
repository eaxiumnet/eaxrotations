...
-- NOTE: This module now integrates with simple_ui for menu creation
...
function RotationSettingsUI.new(config)
    ...
    -- When simple_ui is available, we store settings in a simple_ui-compatible way
    -- When simple_ui is not available, we fall back to raw values
    local default_theme_index = THEME_INDEX[self.theme_name] or 1
    self.menu = {
        enable = { get = function() return true end, set = function() end },
        theme_selector = { get = function() return default_theme_index end, set = function() end },
        pos_x = { get = function() return config.default_x or 700 end, set = function(v) end },
        pos_y = { get = function() return config.default_y or 200 end, set = function(v) end },
        size_x = { get = function() return config.default_w or 450 end, set = function(v) end },
        size_y = { get = function() return config.default_h or 600 end, set = function(v) end },
        active_tab = { get = function() return 1 end, set = function(v) end },
    }
