...
menu.use_predictive_snd                   = core.menu.checkbox(true, "eaxroguecombat_use_predictive_snd")
menu.snd_refresh_seconds                  = core.menu.slider_int(1, 6, 3, "eaxroguecombat_snd_refresh_seconds")
menu.snd_predictive_buffer_seconds        = core.menu.slider_int(3, 8, 5, "eaxroguecombat_snd_predictive_buffer_seconds")
...
function menu.render()
    ...
    root_tree:render("Eax's Rogue Combat", function()
        ...
        main_tree:render("Eax's Rotation Settings", function()
            ...
            menu.use_predictive_snd:render("Predictive SnD", "Use nearby time-to-die to avoid overbuilding Slice and Dice")
            menu.snd_refresh_seconds:render("SnD Refresh", "Refresh Slice and Dice below this many seconds")
            menu.snd_predictive_buffer_seconds:render("SnD TTD Buffer", "Try to let refreshed Slice and Dice expire with roughly this much enemy lifetime left")
