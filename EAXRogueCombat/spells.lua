...
spells.EXPOSE_ARMOR     = { 26866, 12544, 12545, 12546, 8647 }
spells.KILLING_SPREE    = { 51690 }
spells.DEBUFF_EXPOSE_ARMOR = { 26866, 12544, 12545, 12546, 8647 }
spells.DEBUFF_SUNDERED_ARMOR = { 25225, 11597, 11596, 8380, 7405, 7386 }

spells.SHIV = { 5938 }

spells.GARROTE        = { 26839, 11341, 11340, 11339, 8626, 8625, 703 }
spells.RIPOSTE        = { 14251 }
spells.DEBUFF_GARROTE = { 26839, 11341, 11340, 11339, 8626, 8625, 703 }
