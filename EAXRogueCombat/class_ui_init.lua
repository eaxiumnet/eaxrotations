-- class_ui_init.lua  (auto-generated for EAXRogueCombat)
...
local function apply()
    ...
    SPEC_ID = identity.SPEC_IDS.ROGUE_COMBAT
    theme.init(
        CLASS_ID,
        SPEC_ID
    )
...
return { apply = apply, display_name = "Rogue Combat", class_id = CLASS_ID, spec_id = SPEC_ID }
