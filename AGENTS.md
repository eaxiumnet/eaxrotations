...
**Tests**: 335 rotation suites registered in `run_rotation_tests.lua` + 21 leveling suites in `run_leveling_tests.lua` (356 total)
...
├── tests/                     # ~356 test files (335 rotation + 21 leveling suites)
...
- Run `lua EaxRotations/tests/run_rotation_tests.lua` — all 335 rotation suites must pass
