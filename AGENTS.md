...
**Tests**: 381 rotation suites registered in `run_rotation_tests.lua` + 22 leveling suites in `run_leveling_tests.lua` (403 total)
...
- Run `lua EaxRotations/tests/run_rotation_tests.lua` — all 381 rotation suites must pass
- Run `lua EaxRotations/tests/run_leveling_tests.lua` — all 22 leveling suites must pass
