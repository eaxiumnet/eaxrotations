...
**Tests**: 391 rotation suites registered in `run_rotation_tests.lua` + 31 leveling suites in `run_leveling_tests.lua` (422 total)
...
- Run `lua EaxRotations/tests/run_rotation_tests.lua` — all 391 rotation suites must pass
- Run `lua EaxRotations/tests/run_leveling_tests.lua` — all 31 leveling suites must pass
