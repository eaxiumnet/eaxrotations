...
**Tests**: 385 rotation suites registered in `run_rotation_tests.lua` + 26 leveling suites in `run_leveling_tests.lua` (411 total)
...
- Run `lua EaxRotations/tests/run_rotation_tests.lua` — all 385 rotation suites must pass
- Run `lua EaxRotations/tests/run_leveling_tests.lua` — all 26 leveling suites must pass
