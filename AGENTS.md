...
├── tests/                     # ~219 test files (208 rotation + 11 leveling suites)
...
**Scope**: 24 files (14 spec + 9 leveling + 1 shadow), ~170 locations guarded. All 208 rotation + 11 leveling suites pass.
...
- Run `lua EaxRotations/tests/run_rotation_tests.lua` — all 208 rotation suites must pass
