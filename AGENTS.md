...
**Tests**: 352 rotation suites registered in `run_rotation_tests.lua` + 21 leveling suites in `run_leveling_tests.lua` (373 total)
...
- Run `lua EaxRotations/tests/run_rotation_tests.lua` — all 352 rotation suites must pass
