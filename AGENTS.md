...
**Tests**: 342 rotation suites registered in `run_rotation_tests.lua` + 21 leveling suites in `run_leveling_tests.lua` (363 total)
...
├── tests/                     # ~363 test files (342 rotation + 21 leveling suites)
...
- Run `lua EaxRotations/tests/run_rotation_tests.lua` — all 342 rotation suites must pass
