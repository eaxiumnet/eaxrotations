...
**Tests**: 388 rotation suites registered in `run_rotation_tests.lua` + 29 leveling suites in `run_leveling_tests.lua` (417 total)
...
- Run `lua EaxRotations/tests/run_rotation_tests.lua` — all 388 rotation suites must pass
- Run `lua EaxRotations/tests/run_leveling_tests.lua` — all 29 leveling suites must pass
