...
**Tests**: 339 rotation suites registered in `run_rotation_tests.lua` + 21 leveling suites in `run_leveling_tests.lua` (360 total)
...
├── tests/                     # ~360 test files (339 rotation + 21 leveling suites)
...
- Run `lua EaxRotations/tests/run_rotation_tests.lua` — all 339 rotation suites must pass
