...
**Tests**: 338 rotation suites registered in `run_rotation_tests.lua` + 21 leveling suites in `run_leveling_tests.lua` (359 total)
...
├── tests/                     # ~358 test files (337 rotation + 21 leveling suites)
...
- Run `lua EaxRotations/tests/run_rotation_tests.lua` — all 338 rotation suites must pass
