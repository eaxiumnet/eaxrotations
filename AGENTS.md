...
**Tests**: 368 rotation suites registered in `run_rotation_tests.lua` + 21 leveling suites in `run_leveling_tests.lua` (389 total)
...
├── tests/                     # ~389 test files (368 rotation + 21 leveling suites)
...
**Scope**: 24 files (14 spec + 9 leveling + 1 shadow), ~170 locations guarded. All 368 rotation + 21 leveling suites pass.
...
- Run `lua EaxRotations/tests/run_rotation_tests.lua` — all 368 rotation suites must pass
