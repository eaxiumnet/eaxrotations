...
**Tests**: 384 rotation suites registered in `run_rotation_tests.lua` + 25 leveling suites in `run_leveling_tests.lua` (409 total)
...
- Run `lua EaxRotations/tests/run_rotation_tests.lua` — all 384 rotation suites must pass
- Run `lua EaxRotations/tests/run_leveling_tests.lua` — all 25 leveling suites must pass
