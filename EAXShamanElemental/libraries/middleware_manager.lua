-- EAXShamanElemental Middleware Manager
-- Integrates libraries/middleware with Elemental Shaman-specific registrations
...
-- Spell IDs for TBC Elemental Shaman
local SHAMAN_SPELLS = {
    -- Racials
...
--- Initialize and register all Elemental Shaman-specific middleware
