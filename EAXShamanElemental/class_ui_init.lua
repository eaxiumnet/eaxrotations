-- class_ui_init.lua  (auto-generated for EAXShamanElemental)
...
local function apply()
    ...
    SPEC_ID = identity.SPEC_IDS.SHAMAN_ELEMENTAL
    theme.init(
        CLASS_ID,
        SPEC_ID
    )
...
return { apply = apply, display_name = "Shaman Elemental", class_id = CLASS_ID, spec_id = SPEC_ID }
