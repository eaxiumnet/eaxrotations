...
-- Dashboard Settings
menu.dashboard_enabled = core.menu.checkbox(true, "eaxhuntersv_dashboard_enabled")
menu.dashboard_opacity = core.menu.slider_int(50, 255, 190, "eaxhuntersv_dashboard_opacity")
menu.dashboard_x = core.menu.slider_int(0, 1000, 20, "eaxhuntersv_dashboard_x")
menu.dashboard_y = core.menu.slider_int(0, 1000, 200, "eaxhuntersv_dashboard_y")
...
menu.show_energy_tick = core.menu.checkbox(false, "eaxhuntersv_show_energy_tick")
menu.show_combo_points = core.menu.checkbox(false, "eaxhuntersv_show_combo_points")
menu.show_threat_bar = core.menu.checkbox(false, "eaxhuntersv_show_threat_bar")
menu.enable_smart_collapse = core.menu.checkbox(true, "eaxhuntersv_enable_smart_collapse")
