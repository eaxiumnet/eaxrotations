...
menu.use_explosive_shot = core.menu.checkbox(true, "eaxhuntersv_use_explosive_shot")
...
function menu.render()
    ...
    root_tree:render("  Eax's Hunter Survival", function()
        ...
        main_tree:render("  Rotation Settings", function()
            ...
            menu.use_explosive_shot:render("Explosive Shot","SV signature. Instant, on CD. Highest shot priority.")
            ...
            menu.use_aimed_shot:render("Aimed Shot",        "Cast shot filler when stationary. Lower priority than instants.")
        ...
        kite_tree:render("  Kiting & Traps", function()
            ...
            menu.trap_selection:render("Trap Type",       {"Explosive (AoE DMG)", "Immolation (DMG)", "Freezing (CC)"})
