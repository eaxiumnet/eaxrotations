...
-- DPS Fallback
menu.use_moonfire                        = core.menu.checkbox(true, "eaxdruidrestoration_use_moonfire")
menu.use_insect_swarm                    = core.menu.checkbox(true, "eaxdruidrestoration_use_insect_swarm")
menu.use_wrath                           = core.menu.checkbox(true, "eaxdruidrestoration_use_wrath")
menu.use_starfire                        = core.menu.checkbox(true, "eaxdruidrestoration_use_starfire")
...
function menu.render()
    ...
    root_tree:render("Eax's Druid Restoration", function()
        ...
        dps_tree:render("DPS Fallback", function()
            menu.use_moonfire:render("Moonfire", "DoT")
            menu.use_insect_swarm:render("Insect Swarm", "DoT")
            menu.use_wrath:render("Wrath", "Filler")
            menu.use_starfire:render("Starfire", "Cast")
