...
PointerMap.Instances = {
	...
	[558] = {name="Auchindoun: Auchenai Crypts", {file="Auchindoun-AuchenaiCrypts", both=true} },
	[557] = {name="Auchindoun: Mana Tombs", {file="Auchindoun-ManaTombs", both=true} },
	[556] = {name="Auchindoun: Sethekk Halls", {file="Auchindoun-SethekkHalls", both=true} },
	[555] = {name="Auchindoun: Shadow Labyrinth", {file="Auchindoun-ShadowLabyrinth", both=true} },
	[269] = {name="Caverns of Time: Black Morass", {file="CavernsOfTime-BlackMorass", both=true} },
	[560] = {name="Caverns of Time: Old Hillsbrad", {file="CavernsOfTime-OldHillsbrad", both=true} },
	[547] = {name="Coilfang Reservoir: Slave Pens", {file="CoilfangReservoir-SlavePens", both=true} },
	[545] = {name="Coilfang Reservoir: Steamvault", {file="CoilfangReservoir-Steamvault", both=true} },
	[546] = {name="Coilfang Reservoir: Underbog", {file="CoilfangReservoir-Underbog", both=true} },
	[542] = {name="Hellfire Citadel: Blood Furnace", {file="HellfireCitadel-BloodFurnace", both=true} },
	[543] = {name="Hellfire Citadel: Ramparts", {file="HellfireCitadel-Ramparts", both=true} },
	[540] = {name="Hellfire Citadel: Shattered Halls", {file="HellfireCitadel-ShatteredHalls", both=true} },
	[552] = {name="Tempest Keep: Arcatraz", {file="TempestKeep-Arcatraz", both=true} },
	[553] = {name="Tempest Keep: Botanica", {file="TempestKeep-Botanica", both=true} },
	[554] = {name="Tempest Keep: Mechanar", {file="TempestKeep-Mechanar", both=true} },
}
