...
local reptypes = { -- OVERRIDDEN in Classic/WOTLK
	...
	['delvecompanion'] = {
		standings = {
			...
			{ name="Level 14",	from=101997,	color="f4e635"},
			{ name="Level 15",	from=114497,	color="f3e23e"},
			{ name="Level 16",	from=152185,	color="f3e23e"},
			{ name="Level 17",	from=190060,	color="f1de46"},
			{ name="Level 18",	from=228122,	color="f1de46"},
			{ name="Level 19",	from=266372,	color="efda4f"},
			{ name="Level 20",	from=304810,	color="efda4f"},
			{ name="Level 21",	from=343435,	color="edd658"},
			{ name="Level 22",	from=382247,	color="edd658"},
			{ name="Level 23",	from=421247,	color="ecd261"},
			{ name="Level 24",	from=460435,	color="ecd261"},
			{ name="Level 25",	from=499810,	color="eace6a"},
			{ name="Level 26",	from=562310,	color="eace6a"},
			{ name="Level 27",	from=624997,	color="e8ca72"},
			{ name="Level 28",	from=687872,	color="e8ca72"},
			{ name="Level 29",	from=750935,	color="e6c67b"},
			{ name="Level 30",	from=814185,	color="e6c67b"},
			{ name="Level 31",	from=877622,	color="e5c184"},
			{ name="Level 32",	from=941247,	color="e5c184"},
			{ name="Level 33",	from=1005060,	color="e3bd8d"},
			{ name="Level 34",	from=1069060,	color="e3bd8d"},
			{ name="Level 35",	from=1133247,	color="e1b995"},
			{ name="Level 36",	from=1220747,	color="e1b995"},
			{ name="Level 37",	from=1308435,	color="dfb59e"},
			{ name="Level 38",	from=1396310,	color="dfb59e"},
			{ name="Level 39",	from=1484372,	color="deb1a7"},
			{ name="Level 40",	from=1572622,	color="deb1a7"},
			{ name="Level 41",	from=1661060,	color="dcadb0"},
			{ name="Level 42",	from=1749685,	color="dcadb0"},
			{ name="Level 43",	from=1838497,	color="daa9b9"},
			{ name="Level 44",	from=1927497,	color="daa9b9"},
			{ name="Level 45",	from=2016685,	color="d8a5c1"},
			{ name="Level 46",	from=2266685,	color="d8a5c1"},
			{ name="Level 47",	from=2522935,	color="d7a1ca"},
			{ name="Level 48",	from=2785435,	color="d7a1ca"},
			{ name="Level 49",	from=3054185,	color="d59dd3"},
			{ name="Level 50",	from=3329185,	color="d59dd3"},
			{ name="Level 51",	from=3610435,	color="d398dc"},
			{ name="Level 52",	from=3897935,	color="d398dc"},
			{ name="Level 53",	from=4191685,	color="d194e5"},
			{ name="Level 54",	from=4491685,	color="d194e5"},
			{ name="Level 55",	from=4797935,	color="d090ed"},
			{ name="Level 56",	from=5235435,	color="d090ed"},
			{ name="Level 57",	from=5797935,	color="ce8cf6"},
			{ name="Level 58",	from=6485435,	color="ce8cf6"},
			{ name="Level 59",	from=7297935,	color="cc88ff"},
			{ name="Level 60",	from=8172935,	color="cc88ff"},
		},
		check = function(id,fid,ftex)
			return fid==2744
		end
...
function Faction:CacheRepByID(id) -- OVERRIDDEN in Classic
	...
	if not name and (C_MajorFactions and C_Reputation and C_Reputation.IsMajorFaction(id)) then
		local majordata = C_MajorFactions.GetMajorFactionData(id)
		name = majordata and majordata.name
	end
...
function Faction:CacheReputations()
	...
	for id=1,MAX_FACTION_ID do
		...
		if ZGV.IsRetail and not existing_id and C_Reputation.IsMajorFaction(id) then -- hidden major
			existing_id=id		
		end
