...
--		-- Timbermaw Hold Tunnel (Felwood -to- Moonglade)
--			"Felwood/0 65.20,7.77 <radius:15> {title:Run through the Timbermaw Hold tunnel} {cost:40}",
--				"@+ -x- Felwood/0 65.35,7.26 <radius:15> <dark:1> {title:Run through the Timbermaw Hold tunnel} {cost:160} <region:timbermawhold>",
--				"@+ -x- Moonglade 35.74,72.44 <radius:15> {title:Run through the Timbermaw Hold tunnel} {cost:40}",
		
		
--		-- Timbermaw Hold Tunnel (Felwood -x- Winterspring)
--			"Felwood 65.08,8.14 <radius:15> {title:Run through the Timbermaw Hold tunnel} {cost:30}",
--				"@+ -x- Felwood/0 66.22,2.88 <radius:15> <dark:1> {title:Run through the Timbermaw Hold tunnel} {cost:60} <region:timbermawhold>",
--				"@+ -x- Felwood/0 67.89,4.53 <radius:15> <dark:1> {title:Run through the Timbermaw Hold tunnel} {cost:30} <region:timbermawhold>",
--				"@+ -x- Winterspring 27.91,34.45 <radius:15> {title:Run through the Timbermaw Hold tunnel} {cost:30}",

		
--		-- Timbermaw Hold Tunnel (Winterspring -x- Moonglade)
--			"Winterspring 27.91,34.45 <radius:15> {title:Run through the Timbermaw Hold tunnel} {cost:40}",
--				"@+ -x- Felwood/0 65.37,2.46 <radius:15> <dark:1> {title:Run through the Timbermaw Hold tunnel} {cost:240} <region:timbermawhold>",
--				"@+ -x- Moonglade 35.74,72.44 <radius:15> {title:Run through the Timbermaw Hold tunnel} {cost:40}",
		...
		"Felwood/0 65.19,7.78 <radius:15> -x- Felwood/0 65.40,7.02 <radius:15> <region:timbermawhold>"..
			"{title:Run through the Timbermaw Hold tunnel}",	
		
		"Winterspring/0 27.91,34.46 <radius:15> -x- Felwood/0 68.14,5.44 <radius:15> <region:timbermawhold>"..
			"{title:Run through the Timbermaw Hold tunnel}",	
		
		"Moonglade/0 35.72,72.41 <radius:15> -x- Moonglade/0 35.48,74.05 <radius:15> <region:timbermawhold>"..
			"{title:Run through the Timbermaw Hold tunnel}",	
...
--		"Felwood 65.08,8.14 <radius:10> -x- Moonglade 35.74,72.44 <radius:10> {cost:240}"..
--			"{title_atob:Enter the tunnel and follow it north to Moonglade} {title_btoa:Enter the tunnel and follow it west to Felwood}",

--		"Felwood 65.08,8.14 <radius:10> -x- Winterspring 27.91,34.45 <radius:10> {cost:120}"..
--			"{title_atob:Enter the tunnel and follow it east to Winterspring} {title_btoa:Enter the tunnel and follow it west to Felwood}",	
	...
	----------------------------
		...
		"Alterac Mountains/0 79.91,42.63 <radius:40> -x- Western Plaguelands 44.04,86.38 <radius:40> {title_atob:Follow the road into Western Plaguelands} {title_btoa:Follow the road into Alterac Mountains}",
