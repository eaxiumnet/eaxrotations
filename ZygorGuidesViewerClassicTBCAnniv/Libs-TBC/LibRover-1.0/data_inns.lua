...
data.basenodes.inns = {
	...
	['Zangarmarsh']={
		...
		{name="Zangarmarsh",faction="A",npc="Caregiver Abidaar",npcid=18251,x=67.17,y=49.32},
	...
	['Shattrath City']={
		...
		{name="Scryer's Tier",faction="B",npc="Innkeeper Haelthol",npcid=19232,x=56.32,y=81.54},		-- THE SCRYERS
	},
