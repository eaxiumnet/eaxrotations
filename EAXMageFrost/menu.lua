...
menu.use_winters_chill                    = core.menu.checkbox(true, "eax_mage_frost_use_winters_chill")
menu.winters_chill_refresh                = core.menu.slider_int(1, 5, 3, "eax_mage_frost_winters_chill_refresh")
menu.use_cold_snap                        = core.menu.checkbox(true, "eax_mage_frost_use_cold_snap")
...
function menu.render()
    ...
    root_tree:render("Eax's Mage Frost", function()
        ...
        main_tree:render("Eax's Rotation Settings", function()
            ...
            menu.use_winters_chill:render("Winter's Chill", "Prefer Frostbolt to maintain Winter's Chill stacks")
            menu.winters_chill_refresh:render("Winter's Chill Refresh", "Refresh Winter's Chill before it expires")
            menu.use_cold_snap:render("Cold Snap", "Reset key frost cooldowns when it has real value")
