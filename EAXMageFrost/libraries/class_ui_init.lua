-- class_ui_init.lua  (auto-generated for EAXMageFrost)
...
local function apply()
    ...
    CLASS_ID = identity.CLASS_IDS.MAGE
    SPEC_ID = identity.SPEC_IDS.MAGE_FROST
    theme.init(
        CLASS_ID,
        SPEC_ID
    )
...
return { apply = apply, display_name = "Mage Frost", class_id = CLASS_ID, spec_id = SPEC_ID }
