...
- `01-performance-optimization.md` (Jun 9)
- `02-shaman-tbc-rotation.md` (Jun 10)
...
- `api-integration-2026-06.md` (2026-06-19 — all 8 APIs verified wired, orphan modules resolved)
- `eaxrotations-cross-class-robustness-sweep.md` (2026-06-19 — raw unit comparisons, get_power constants, build_state throttling all resolved)
