...
| `plans/api-standardization-audit-2026-07.md` | In progress (Phase 0 complete; Phase 1: fixed uncached core.* in 9+ shared modules per Pattern 2: ... + combat_log spell_name, snap_threat, spell_resolver, pet_heal) | Full API pattern compliance audit across all ~210 EaxRotations files (Groups A-I) |
