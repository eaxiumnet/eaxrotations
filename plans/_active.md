...
**Last updated:** 2026-07-09 (new plan `api-standardization-audit-2026-07` added)
...
| `plans/api-standardization-audit-2026-07.md` | In progress (Phase 0 complete; Phase 1: fixed uncached core.* in 6+ shared modules per Pattern 2: hot_tick, combat_log, incoming_heal, fsr, trinket, pet_manager, pet_heal) | Full API pattern compliance audit across all ~210 EaxRotations files (Groups A-I) |
