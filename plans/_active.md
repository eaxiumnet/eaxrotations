...
| `plans/api-standardization-audit-2026-07.md` | In progress (Phase 0 complete; Phase 1: fixed uncached core.* in 4 shared modules per Pattern 2: hot_tick, combat_log, incoming_heal, fsr) | Full API pattern compliance audit across all ~210 EaxRotations files (Groups A-I) |
