...
| `plans/refactor-developer-experience-2026-06.md` | Active | spec_kit migration (22 of 29 specs done: arms, fury, protection, kebab, balance, cat, bear, caster, resto, discipline, holy, shadow, fire, destruction, frost, restoration, affliction, combat, demonology, elemental, enhancement, assassination) + healing_sylvanas helper |
...
- 234 test suites — automated quality (22 of 29 specs converted to spec_kit)
