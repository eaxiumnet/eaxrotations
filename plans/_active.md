...
| `plans/integrate-advanced-modules-2026-07-13.md` | In progress (Phases 1-7 complete) | Integrate 8 advanced Sylvanas modules into TBC + WotLK + Classic rotations. Phases 1-7 complete: combat_forecast CD gating, health_prediction direct API, spell_prediction AoE, target_selector direct queries, buff_manager bulk aura access, profiler diagnostics, spell_queue direct access. Phase 8 (WotLK spec module integration) next. Verified: 268 rotation + 18 leveling + 6 WotLK suites pass. |
