...
> up to date after every work session. Last updated: **2026-07-22** (Strategy DSL 100% coverage — all 29/29 specs adopted; final 3: caster druid, smite priest, kebab warrior; baseline re-verified 350 rotation + 21 leveling = 371 total suites green).
...
- **Baseline is GREEN:** **350 rotation suites + 21 leveling suites (371 total)** pass on
...
files → rotation suite (350) → leveling suite (21) → spell audit. All on Lua
...
**Baseline:** 350 rotation + 21 leveling suites PASS / 0 fail on Lua 5.1.5.
...
- `EaxRotations/tests/run_rotation_tests.lua` — rotation suite runner (350 suites).
