...
> up to date after every work session. Last updated: **2026-07-22** (Strategy DSL 100% coverage — all 29/29 specs adopted; final 3: caster druid, smite priest, kebab warrior; baseline re-verified 369 rotation + 21 leveling = 390 total suites green (21 of 41 WotLK specs on strategy DSL)).
...
- **Baseline is GREEN:** **369 rotation suites + 21 leveling suites (390 total)** pass on
...
**Baseline:** 369 rotation + 21 leveling suites PASS / 0 fail on Lua 5.1.5.
