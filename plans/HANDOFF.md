...
> up to date after every work session. Last updated: **2026-07-07** (spec_kit migration #13 complete; HEAD `0c439e96`, pushed to origin).
...
- **What's done (2026-06-27 → 2026-07-07, 284 commits):**
  ...
  - **EaxFishing v2.5.1** — debug throttling, stealth suspicion decay/reset, verbose
    status logging.
  - **spec_kit migration** — 13 of 29 specs converted to `spec_kit.safe_state` +
    `define_action_for_class` (arms, fury, protection, kebab, balance, cat, bear, caster, resto, discipline, holy, shadow, fire).
...
## CURRENT STATE (verified 2026-07-07, HEAD 0c439e96)
...
| spec_kit | 13 specs migrated to safe_state + define_action_for_class | `0c439e96` (latest) | arms, fury, protection, kebab, balance, cat, bear, caster, resto, discipline, holy, shadow, fire |
...
### spec_kit migration progress (13 of 29 specs)
...
| fire | ✅ Done (latest) | 18 ACTION entries, `FIRE_SCHEMA`, 42 SPELLS.X refs converted |
| (16 remaining) | Not started | Convert only when already editing a spec |
...
- 13 of 29 specs converted (arms, fury, protection, kebab, balance, cat, bear, caster, resto, discipline, holy, shadow, fire).
