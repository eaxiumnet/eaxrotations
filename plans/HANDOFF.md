...
> up to date after every work session. Last updated: **2026-07-07** (spec_kit migration #12 complete; HEAD `624934d0`, pushed to origin).
...
- **What's done (2026-06-27 → 2026-07-07, 284 commits):**
  ...
  - **EaxFishing v2.5.1** — debug throttling, stealth suspicion decay/reset, verbose
    status logging.
  - **spec_kit migration** — 12 of 29 specs converted to `spec_kit.safe_state` +
    `define_action_for_class` (arms, fury, protection, kebab, balance, cat, bear, caster, resto, discipline, holy, shadow).
...
## CURRENT STATE (verified 2026-07-07, HEAD 624934d0)
...
| spec_kit | 12 specs migrated to safe_state + define_action_for_class | `624934d0` (latest) | arms, fury, protection, kebab, balance, cat, bear, caster, resto, discipline, holy, shadow |
...
### spec_kit migration progress (12 of 29 specs)
...
| shadow | ✅ Done (latest) | 23 ACTION entries, `SHADOW_SCHEMA`, 61 SPELLS.X refs converted |
| (17 remaining) | Not started | Convert only when already editing a spec |
...
- 12 of 29 specs converted (arms, fury, protection, kebab, balance, cat, bear, caster, resto, discipline, holy, shadow).
