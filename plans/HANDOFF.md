...
> up to date after every work session. Last updated: **2026-07-21** (strategy DSL + lazy context landed 2026-07-19; 27 DSL adoptions committed — arms, fury, combat rogue, balance druid, protection paladin, restoration shaman, beast mastery hunter, shadow priest, frost mage, arcane mage, fire mage, enhancement shaman, destruction warlock, demonology warlock, bear druid, feral cat druid, assassination rogue, subtlety rogue, elemental shaman, retribution paladin, discipline priest, survival hunter, marksmanship hunter, affliction warlock, protection warrior, holy paladin, restoration druid; `tests/_staging/` debris cleaned; baseline re-verified 342 rotation + 21 leveling = 363 total suites green).
...
- **Baseline is GREEN:** **342 rotation suites + 21 leveling suites (363 total)** pass on
...
- **What's next:** (1) Continue spec_kit migration (only when already editing a
  ...
  strategy DSL adoption — 27 of 29 specs on DSL (arms, fury, combat rogue, balance
  druid, protection paladin, restoration shaman, beast mastery hunter, shadow priest, frost mage, arcane mage, fire mage, enhancement shaman, destruction warlock, demonology warlock, bear druid, feral cat druid, assassination rogue, subtlety rogue, elemental shaman, retribution paladin, discipline priest, survival hunter, marksmanship hunter, affliction warlock, protection warrior, holy paladin, restoration druid); a 28th spec
  from a new class (e.g. holy paladin, holy priest, or caster druid) would continue expanding coverage. (2) `become-1-rotation-system`
...
**Baseline:** 342 rotation + 21 leveling suites PASS / 0 fail on Lua 5.1.5.
...
- **27 of 29 specs on DSL** (arms `37f4bb01`, fury `33c77110`, combat rogue `f280bd72`,
...
- Next candidates: a spec from a remaining class to finish DSL coverage
  (e.g. holy paladin, holy priest, or caster druid).
