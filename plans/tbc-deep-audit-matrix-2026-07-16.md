...
| **Warlock** | SB/Corr/Imm L10; Conflag/UA blocked | mid | Conflag 40 | UA 50 | L70 | LifeTap path | curse_mode + assigned_curse + amplify + potions ON/OFF | Rain/Hellfire/Seed multi | Shadowburn&lt;SB | 4 setting flips + prio | **OK** |
...
| **Rogue** | SS/Evis L10 | SnD/Rupture | AR/BF | Mutilate 50 | Envenom 62 | energy builders | use_cooldowns BF + BF count + expose_assigned + potions | BladeFlurry multi + SnD | SnD&lt;Evis | 4 setting flips + prio | **OK** |
...
| Warlock | **warlock_curse_mode**, **warlock_assigned_curse**, **aff_use_amplify_curse**, **use_auto_potions** (DamagePotion) — ON/OFF |
| Mage | **use_scorch_debuff** (Fireball when off), **use_cooldowns** (Combustion), **use_mana_gem** — ON/OFF |
| Rogue | **use_cooldowns** (BladeFlurry), **combat_blade_flurry_count**, **combat_expose_assigned**, **use_auto_potions** (HealthPotion) — ON/OFF |
