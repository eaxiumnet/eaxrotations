...
### Wave 3
- [x] T4: Low-scoring spec fixes

### Wave 4
- [x] T7: Scorecard update & final validation

### Wave 5
- [x] T8: Plan archive & _active.md update
...
- [x] All 5 scenarios pass (core gates met; offensive dispel tests partial) their binary pass conditions
- [x] `luac -p` passes on every modified file
- [x] `lua EaxRotations/tests/run_rotation_tests.lua` passes (305/305)
- [x] `lua EaxRotations/tests/run_leveling_tests.lua` passes (21/21)
- [x] Changed files pass pre-commit luac + audits
- [x] Scorecard average improves from 4.26 to **4.41**
- [x] No `api/` or `.api/` files modified
- [x] No banned APIs (`ffi.C`, `io.popen`, `os.execute`, `debug.*`) introduced
- [x] Plan archived and `plans/_active.md` updated


## Campaign Result (2026-07-16)

- Rotation: **305/305 PASS**
- Leveling: **21/21 PASS**
- Scorecard overall_average: **4.41** (was 4.26)
- Key commits: shared module hardening, vanilla strategy suites, leveling adaptive, caster Starfire/HT, healing helper triage tests
