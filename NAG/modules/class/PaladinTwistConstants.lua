...
local PaladinTwistConstants = {
    TBC_BLOOD_ELF_RACE_ID = 10,
    TBC_TWIST_SEAL_BLOOD_ID = 31892,
    TBC_TWIST_SEAL_MARTYR_ID = 53720,
    ...
    -- Seal of Blood / Seal of the Martyr cast, aura, and accepted variant IDs.
    RET_TWIST_SOB_IDS = {
        31892,
        31893,
        53720,
    ...
    RET_TWIST_SOB_FAMILY_IDS = {
        31892,
        31893,
    },

    RET_TWIST_SOM_FAMILY_IDS = {
        53720,
        348700,
        348701,
    },
