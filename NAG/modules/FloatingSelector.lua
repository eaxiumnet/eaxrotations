...
function FloatingSelector:OnAssignmentChanged()
    self:UpdateAssignmentHintIcons()
end
...
function FloatingSelector:BuildAssignmentsSubmenu(classModule)
    ...
    for _, assignment in ipairs(assignments) do
        ...
        local slashHint = (assignment.slashCommand and assignment.slashCommand ~= "") and (" |cff888888(/nag " .. assignment.slashCommand .. ")|r") or ""
        tinsert(menuList, {
            text = spellIcon .. assignment.name .. slashHint,
