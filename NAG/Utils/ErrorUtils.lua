...
--- - Uses db.global.enableDevMode as the single source of truth (NAG options or /nagdebug devmode)
--- - Enhanced error reporting only when Developer Mode is enabled
---
