...
function NAG:SpellIsKnown(spellId)
    ...
    -- During spellbook invalidation, bypass DataManager-backed registration paths and
    -- fall back to direct spellbook knowledge checks only.
    if SpellbookManager and SpellbookManager.IsHandlingSpellAffectingEvent
        and SpellbookManager:IsHandlingSpellAffectingEvent() then
