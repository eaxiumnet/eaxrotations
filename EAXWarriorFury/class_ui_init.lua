-- class_ui_init.lua  (auto-generated for EAXWarriorFury)
...
local function apply()
    ...
    SPEC_ID = identity.SPEC_IDS.WARRIOR_FURY
    theme.init(
        CLASS_ID,
        SPEC_ID
    )
...
return { apply = apply, display_name = "Warrior Fury", class_id = CLASS_ID, spec_id = SPEC_ID }
