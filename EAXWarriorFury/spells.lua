...
spells.RAMPAGE = { 30033, 30030, 29801 }
...
-- Consumable items
-- Highest-to-lowest item preference from the local archive id index.
...
spells.BUFF_RAMPAGE = { 30033, 30030, 29801 }
spells.BUFF_STONEFORM = { 20594 }
spells.BUFF_FLURRY = { 16259, 16258, 16257, 16256, 12974 }
spells.BUFF_ENRAGE = { 14204, 14203, 14202, 14201, 12880 }
...
spells.BUFF_SPELL_REFLECTION   = { 23920, 23919 }
