-- EAXWarriorFury Middleware Manager
-- Integrates libraries/middleware with Warrior-specific registrations
...
--- Initialize and register all Warrior-specific middleware
