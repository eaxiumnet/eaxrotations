-- class_ui_init.lua  (auto-generated for EAXPriestShadow)
...
local function apply()
    ...
    SPEC_ID = identity.SPEC_IDS.PRIEST_SHADOW
    theme.init(
        CLASS_ID,
        SPEC_ID
    )
...
return { apply = apply, display_name = "Priest Shadow", class_id = CLASS_ID, spec_id = SPEC_ID }
