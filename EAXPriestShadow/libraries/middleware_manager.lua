--[[
    middleware_manager.lua - Middleware Manager for Priest Shadow
...
--- Setup middleware for Priest Shadow
...
function middleware_manager.setup(menu, spells)
    ...
    print("[EAX Shadow] Middleware registered: " .. middleware.count() .. " items")
end
