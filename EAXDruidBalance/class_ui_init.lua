-- class_ui_init.lua  (auto-generated for EAXDruidBalance)
...
local function apply()
    ...
    SPEC_ID = identity.SPEC_IDS.DRUID_BALANCE
    theme.init(
        CLASS_ID,
        SPEC_ID
    )
...
return { apply = apply, display_name = "Druid Balance", class_id = CLASS_ID, spec_id = SPEC_ID }
