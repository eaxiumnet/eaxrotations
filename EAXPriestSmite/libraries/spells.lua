-- EAXPriestSmite spells.lua
-- TBC-only spell tables for Smite (Holy DPS) automation.
-- Hybrid of Holy healing and Shadow damage spells

local spells = {}

-- Core Damage (Smite spec)
...
spells.RESURRECTION = { 25435, 25434, 20770, 20769, 2011, 2006, 2005, 2004, 2003, 2002, 2001 }
...
spells.BUFF_FORTITUDE = { 1243, 1244, 1245, 2791, 10936, 10937, 10938, 25389, 21562, 21564, 25392 }
