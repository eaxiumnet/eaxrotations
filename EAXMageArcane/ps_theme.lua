...
ps.col = {
    panel        = c(  5, 15, 20, 252),
    panel_deep   = c(  3,  9, 14, 240),
    border_glow  = c(180,140,255, 220),
    border_dim   = c( 15, 90,110, 160),
    accent       = c(160,120,255, 255),
    accent_mid   = c( 25,150,170, 255),
    text_on      = c(200,160,255, 255),
    text_off     = c( 25, 90,105, 255),
    transparent  = c(  0,   0,   0,   0),
}

local STAR_R, STAR_G, STAR_B = 160, 120, 255
local DUST_R, DUST_G, DUST_B = 15, 130, 170
