...
function menu.render()
    ...
    root_tree:render("Eax's Mage Arcane", function()
        ...
        main_tree:render("Rotation", function()
            ps.header("Rotation")
            menu.use_arcane_blast:render("Arcane Blast", "")
            menu.use_arcane_missiles:render("Arcane Missiles", "")
            menu.use_arcane_surge:render("Arcane Surge", "")
            menu.use_evocation:render("Evocation", "")
            menu.use_missile_barrage:render("Missile Barrage", "")
