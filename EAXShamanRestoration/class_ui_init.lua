-- class_ui_init.lua  (auto-generated for EAXShamanRestoration)
...
local function apply()
    ...
    SPEC_ID = identity.SPEC_IDS.SHAMAN_RESTO
    theme.init(
        CLASS_ID,
        SPEC_ID
    )
...
return { apply = apply, display_name = "Shaman Resto", class_id = CLASS_ID, spec_id = SPEC_ID }
