...
menu.bloodlust_on_pull                    = core.menu.checkbox(false, "bloodlust_on_pull")
...
menu.auto_totem_wrath_of_air              = core.menu.checkbox(false, "auto_totem_wrath_of_air")
...
menu.use_purge                            = core.menu.checkbox(false, "use_purge")
