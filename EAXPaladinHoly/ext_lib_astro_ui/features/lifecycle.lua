...
function RotationSettingsUI:_is_enabled()
    -- Using simple_ui internal settings instead of core.menu
...
function RotationSettingsUI:_render_search_bar(y_offset)
    ...
    -- Search text input - simplified for simple_ui compatibility
    -- Note: text_input from core.menu is not available in simple_ui
    -- This is a placeholder for future simple_ui text input implementation
        ...
        function()
            ...
            for _, ui in ipairs(windows) do
                ...
                if lw:is_rect_clicked(row_start, row_end) or (hovered and lw:is_mouse_button_clicked(0)) then
                    ...
                    pcall(function()
                        -- Toggle using simple_ui internal settings
                        if ui._settings then
                            ui._settings.enable = not enabled
                        end
                    end)
                end
