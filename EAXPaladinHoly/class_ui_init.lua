-- class_ui_init.lua  (auto-generated for EAXPaladinHoly)
...
local function apply()
    ...
    SPEC_ID = identity.SPEC_IDS.PALADIN_HOLY
    theme.init(
        CLASS_ID,
        SPEC_ID
    )
...
return { apply = apply, display_name = "Paladin Holy", class_id = CLASS_ID, spec_id = SPEC_ID }
