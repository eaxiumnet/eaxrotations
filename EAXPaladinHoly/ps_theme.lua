...
-- -- Palette ------------------------------------------------------------------
ps.col = {
    panel        = c( 16, 10, 20, 252),
    panel_deep   = c( 10,  6, 14, 240),
    border_glow  = c(255,235,250, 220),
    border_dim   = c(140, 60,100, 160),
    accent       = c(255,215,230, 255),
    accent_mid   = c(220,100,150, 255),
    text_on      = c(255,255,255, 255),
    text_off     = c(130, 70,100, 255),
    transparent  = c(  0,   0,   0,   0),
}

local STAR_R, STAR_G, STAR_B = 255, 215, 230
local DUST_R, DUST_G, DUST_B = 240, 130, 170
