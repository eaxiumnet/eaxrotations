...
menu.use_cleansing = core.menu.checkbox(true, "eaxpaladinholy_use_cleansing")
...
function menu.render()
    ...
    root_tree:render("Eax's Paladin Holy", function()
        ...
        main_tree:render("Rotation", function()
            ps.header("Rotation")
            menu.use_holy_light:render("Holy Light", "")
            menu.use_flash_of_light:render("Flash of Light", "")
            menu.use_holy_shock:render("Holy Shock", "")
            menu.use_divine_illumination:render("Divine Illumination", "")
            menu.use_beacon:render("Beacon", "")
            menu.use_cleansing:render("Cleansing", "")
