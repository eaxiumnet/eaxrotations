...
menu.greater_heal_hp_pct                = core.menu.slider_int(0, 100, 70, "eaxpriestholy_greater_heal_hp_pct")
menu.use_flash_heal                      = core.menu.checkbox(true, "eaxpriestholy_use_flash_heal")
menu.flash_heal_hp_pct                  = core.menu.slider_int(0, 100, 80, "eaxpriestholy_flash_heal_hp_pct")
...
menu.circle_of_healing_enabled           = core.menu.checkbox(true, "eaxpriestholy_circle_of_healing_enabled")
menu.circle_of_healing_threshold         = core.menu.slider_int(0, 100, 70, "eaxpriestholy_circle_of_healing_threshold")
menu.circle_of_healing_count             = core.menu.slider_int(2, 10, 3, "eaxpriestholy_circle_of_healing_count")
...
menu.prayer_of_mending_hp_pct           = core.menu.slider_int(0, 100, 75, "eaxpriestholy_prayer_of_mending_hp_pct")
