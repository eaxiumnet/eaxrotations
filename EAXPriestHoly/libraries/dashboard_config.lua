--[[
    dashboard_config.lua - Dashboard Configuration for Priest Holy
...
local dashboard_config = {
    ...
    buffs = {
        ...
        -- Holy-specific buffs
        {id = 25314, label = "Greater Heal"},
        {id = 25213, label = "Flash Heal"},
        {id = 25235, label = "Binding Heal"},
        {id = 25315, label = "Prayer of Healing"},
        {id = 34861, label = "Circle of Healing"},
        {id = 25429, label = "Holy Nova"},
        {id = 20711, label = "Spirit of Redemption"},
    },
