...
function RotationSettingsUI:enable_presets(menu_elements, md_instance)
    ...
    self._preset = {
        ...
        selector = menu_combobox(1, "preset_sel_" .. self.id),
        name_inputs = {
            core.menu.text_input("preset_nm1_" .. self.id, true),
            core.menu.text_input("preset_nm2_" .. self.id, true),
            core.menu.text_input("preset_nm3_" .. self.id, true),
        },
        dropdown_open = false,
        names_loaded = false,
    }
