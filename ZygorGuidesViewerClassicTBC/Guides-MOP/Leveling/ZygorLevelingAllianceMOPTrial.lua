...
ZygorGuidesViewer:RegisterGuidePlaceholder("Leveling Guides\\Pandaria (85-90)\\Operation: Shieldwall")
ZygorGuidesViewer:RegisterGuidePlaceholder("Leveling Guides\\Pandaria (85-90)\\Trial of the Black Prince")
