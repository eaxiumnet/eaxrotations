...
data.basenodes.borders = --[[LIBROVER]] {
	...
	-- Kalimdor
		...
		"Ashenvale 68.6,86.8 -x- The Barrens 42.8,12.5",
		...
		"Durotar 34.1,42.4 -x- The Barrens 69.0,39.0",
		...
		"The Barrens 27.3,48.0 -x- Southern Barrens 36.7,4.8",
		--"The Barrens 70.2,73.3 -x- The Cape of Stranglethorn 39.0,67.0", -- this is a ship!!
