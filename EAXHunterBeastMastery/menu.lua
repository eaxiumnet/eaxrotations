...
menu.viper_mana_exit    = core.menu.slider_int(50, 100, 85, "eaxhunterbm_viper_exit")
...
menu.stealth_scan_radius = core.menu.slider_float(6.0, 30.0, 20.0, "eaxhunterbm_stealth_scan_radius")
...
function menu.render()
    ...
    root_tree:render("  Eax's Hunter Beast Mastery", function()
        ...
        main_tree:render("  Rotation Settings", function()
            ...
            menu.use_arcane_shot:render("Arcane Shot",     "Instant filler. Only when auto-shot is not about to fire.")
            menu.use_aimed_shot:render("Aimed Shot", "OFF by default for BM - 3s cast clips auto shot weave, net DPS loss. Enable only if leveling solo with no pet.")
        ...
        pet_tree:render("  Pet Settings", function()
            ...
            menu.use_intimidation:render("Intimidation",   "Pet stun (3 sec). Used in combat when available.")
        ...
        kite_tree:render("  Kiting & Traps", function()
            ...
            menu.trap_selection:render("Trap Type",      {"Immolation (Damage)", "Frost (AoE Slow)"})
